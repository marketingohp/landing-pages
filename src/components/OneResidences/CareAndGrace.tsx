  ...
  const amenities = [
    {
      ...
      icon: "/images/amenities/pooll.webp",
    },
    {
      name: "Fully Equipped Indoor & Outdoor Gym",
      icon: "/images/amenities/FULLY_EQUIPPED_INDOOR_&_OUTDOOR_GYM.webp",
    },
    {
      name: "Yoga & Pilates Studio",
      icon: "/images/amenities/YOGA_&_PILATES_STUDIO.webp",
    },
    {
      name: "Wellness Spa with Sauna & Treatment Rooms",
      icon: "/images/amenities/sap.webp",
    },
    {
      name: "Multipurpose Hall",
      icon: "/images/amenities/MULTIPURPOSE_HALL.webp",
    },
    {
      name: "Mini-Golf Course",
      icon: "/images/amenities/MINI-GOLF_COURSE.webp",
    },
    {
      name: "Multi-Purpose Sports Court",
      icon: "/images/amenities/MULTI-PURPOSE_SPORTS_COURT.webp",
    },
    {
      name: "Family BBQ Area",
      icon: "/images/amenities/FAMILY_BBQ_AREA.webp",
    },
    // {

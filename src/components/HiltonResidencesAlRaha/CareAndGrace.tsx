  ...
  const amenities = [
    {
      ...
      icon: "/images/hilton-residences-al-raha/amenities/Basement_parking.png",
    },
    {
      name: "BBQ Area",
      icon: "/images/hilton-residences-al-raha/amenities/BBQ_area.png",
    },
    {
      name: "Changing Rooms",
      icon: "/images/hilton-residences-al-raha/amenities/Changing_rooms.png",
    },
    {
      name: "Fitness Studio ",
      icon: "/images/hilton-residences-al-raha/amenities/Fitness_studio.png",
    },
    {
      name: "Outdoor Cinema",
      icon: "/images/hilton-residences-al-raha/amenities/Outdoor_cinema.png",
    },
    {
      name: "Outdoor Swimming Pool",
      icon: "/images/hilton-residences-al-raha/amenities/Outdoor_swimming_pool.png",
    },
    {
      name: "Pool Seating Area",
      icon: "/images/hilton-residences-al-raha/amenities/Pool_seating_area.png",
    },
    {
      name: "Valet Parking",
      icon: "/images/hilton-residences-al-raha/amenities/Valet_parking.png",
    },
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#533d21] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#533d21] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#533d21] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#533d21]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors relative z-20"
          >

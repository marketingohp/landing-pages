...
export default function InteriorCarousel() {
  ...
  const images = [
    "images/one-residences/one_residences_6.webp",
    "images/one-residences/one_residences_7.webp",
    "images/one-residences/one_residences_5.webp",
    "images/one-residences/one_residences_4.webp",
    "images/one-residences/one_residences_3.webp",
  ];

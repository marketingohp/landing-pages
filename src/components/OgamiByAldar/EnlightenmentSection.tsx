...
export default function EnlightenmentSection() {
  ...
  return (
    <section
      className="py-20 lg:py-32 bg-[#FFFDFB] dark:bg-[#1a1a1a]"
      style={{ paddingBottom: "40px", paddingTop: "0" }}
    >
      <div className="container mx-auto py-10 px-4 lg:px-8">
        <div className="text-center mb-12">
          <h2
            className="text-2xl md:text-4xl lg:text-5xl text-[#634B42] dark:text-white mb-8"
        ...
        {/* <div className="max-w-5xl mx-auto mb-8">
          <div className="relative aspect-video rounded-lg overflow-hidden bg-[#00314a] dark:bg-[#2a4a6c]">
            <video
              ...
              autoPlay
              loop
              poster="/images/ogami-by-aldar/keywords/granada_exterior_01.webp"
        ...
        <div className="text-center">
          {/* <p className="text-base sm:text-lg text-[#634B42] dark:text-white max-w-4xl mx-auto mb-8 sm:mb-10 md:mb-12 px-2">
            {t("royal.enlightenment.desc2")}
          </p> */}
          <button
            onClick={handleClickOpen}
            className="bg-[#634B42] dark:bg-[#634B42] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#493730]/80 dark:hover:bg-[#493730]/80 transition-colors"
          >
            {t("form.register")}
          </button>
        </div>

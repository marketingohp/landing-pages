...
export default function CareAndGrace() {
  ...
  const amenities = [
  {
    name: "Swimmable Lagoons",
    icon: "/images/ogami-by-aldar/amenities/swimming_pool.png"
  },
  {
    name: "Multi-layered Beach",
    icon: "/images/ogami-by-aldar/amenities/beach.png"
  },
  {
    name: "Clubhouse",
    icon: "/images/ogami-by-aldar/amenities/clubhouse.png"
  },
  {
    name: "Wellness Center",
    icon: "/images/ogami-by-aldar/amenities/wellness_center.png"
  },
  {
    name: "Padel & Tennis Courts",
    icon: "/images/ogami-by-aldar/amenities/sports_court.png"
  },
  {
    name: "Retail Village",
    icon: "/images/ogami-by-aldar/amenities/retail_shops.png"
  },
  {
    name: "Beachfront Dining",
    icon: "/images/ogami-by-aldar/amenities/restuarant.png"
  },
  {
    name: "Infinity Pools & Sea View Lounges",
    icon: "/images/ogami-by-aldar/amenities/swimming_pool.png"
  }
];

  return (
    <section className="py-20 lg:py-32 bg-[[#634B42]] dark:bg-[#[#634B42]] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#634B42] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities?.map((amenity, index) => (
            ...
            >
              <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-[#634B42] dark:bg-[#634B42] flex items-center justify-center shadow-lg text-4xl hover:scale-110 transition-transform duration-300">
                <img
                  src={amenity.icon}
                  width={60}
                  height={60}
              ...
              <p className="text-[#634B42] dark:text-white text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#634B42] dark:bg-[#634B42] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#493730]/80 dark:hover:bg-[#493730]/80 transition-colors relative z-20"
          >

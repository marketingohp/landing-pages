  ...
  return (
    <section className="py-20 lg:py-32 bg-[#1a1a1a] dark:bg-[#0a0a0a] relative">
      <div className="absolute inset-0 opacity-20 dark:opacity-20">
        <Image
          src="images/yas-riva/yas_riva_residences5.webp"
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="order-2 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <div
              className="text-[#064851] dark:text-[#b29679] text-7xl md:text-8xl lg:text-9xl font-bold mb-4 font-mobile-payment-plan2"

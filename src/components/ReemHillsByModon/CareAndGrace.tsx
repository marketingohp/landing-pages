...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "Spacious And Continuous Parks",
      icon: "/images/reem-hills-by-modon/amenities/park.png",
    },
    {
      name: "Beach Access",
      icon: "/images/reem-hills-by-modon/amenities/beach.png",
    },
    {
      name: "Private Pools",
      icon: "/images/reem-hills-by-modon/amenities/pool.png",
    },
    {
      name: "Retail Shops",
      icon: "/images/reem-hills-by-modon/amenities/retail_shops.png",
    },
    {
      name: "Club Houses",
      icon: "/images/reem-hills-by-modon/amenities/club.png",
    },
    {
      name: "Jogging & Cycling Tracks",
      icon: "/images/reem-hills-by-modon/amenities/cycle.png",
    },
    {
      name: "Playgrounds",
      icon: "/images/reem-hills-by-modon/amenities/playground.png",
    },
    {
      name: "Gated Community",
      icon: "/images/reem-hills-by-modon/amenities/community.png",
    },
    {
      name: "Cafes & Restaurants",
      icon: "/images/reem-hills-by-modon/amenities/restaurant.png",
    },
  ];
    ...
    <section className="py-20 lg:py-32 bg-[#FFF9F3] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#014538] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#014538] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#014538] dark:bg-[#014538] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#050708]/80 dark:hover:bg-[#050708]/60 transition-colors relative z-20"
          >

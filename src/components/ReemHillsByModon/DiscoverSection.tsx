...
export default function DiscoverSection() {
  ...
  const destinations = [
    ...
    {
      time: "3 MINUTES",
      icon: "/images/reem-hills-by-modon/locations/reem_hospital.png",
      destination: "Reem Hospital",
    },
    {
      time: "3 MINUTES",
      icon: "/images/reem-hills-by-modon/locations/reem_mall.png",
      destination: "Reem Mall",
    },
    {
      time: "3 MINUTES",
      icon: "/images/reem-hills-by-modon/locations/sorbonne_university.png",
      destination: "Sorbonne University",
    },
    // Row 2
    {
      time: "6 MINUTES",
      icon: "/images/reem-hills-by-modon/locations/repton_school.png",
      destination: "Repton School",
    },
    {
      time: "9 MINUTES",
      icon: "/images/reem-hills-by-modon/locations/auh_center.png",
      destination: "AUH City Centre",
    },
    {
      time: "9 MINUTES",
      icon: "/images/reem-hills-by-modon/locations/abu_dhabi_mall.png",
    ...
    <section className="py-12 sm:py-16 md:py-20 lg:py-32 bg-[#FFF9F3] dark:bg-[#1a1a1a]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <h2
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#014538] dark:text-white mb-4 sm:mb-6 md:mb-8"
          ...
          <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
              ...
              <div className="grid grid-cols-2 sm:hidden gap-4">
                {destinations.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="text-[#014538] dark:text-white font-bold text-xs mb-0.5">
                      {item.destination}
                    </div>
                    <div className="text-[#014538] dark:text-gray-400 text-[10px] leading-tight">
                      {item.time}
                    </div>
                  </div>
                ))}
              ...
              <div className="hidden sm:grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                {destinations.map((item, index) => (
                  ...
                  >
                    ...
                    {/* Destination */}
                    <div className="text-[#014538] dark:text-white font-bold text-sm md:text-base mb-1">
                      {item.destination}
                    </div>
                    <div className="text-[#014538] dark:text-gray-400 text-xs md:text-sm leading-tight px-1">
                      {item.time}
                    </div>
                  </div>
                ))}
            ...
            <div className="order-1 lg:order-2">
              <div className="bg-white dark:bg-[#050708] rounded-lg p-4 sm:p-5 md:p-6 shadow-lg">
                {/* Title */}
                {/* <h3 className="text-[#014538] dark:text-white font-bold text-sm sm:text-base md:text-lg lg:text-xl mb-4 sm:mb-5 md:mb-6 uppercase tracking-wide text-center lg:text-left leading-tight sm:leading-normal">
                ...
                <div className="relative mb-3 sm:mb-4">
                  ...
                  >
                    <Image
                      src="images/reem-hills-by-modon/reem_hills_map.jpg"
                      alt="Location Map"
                      fill

...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "Swimming Pool",
      icon: "/images/radiant-waves/amenities/AmpleParking.png",
    },
    {
      name: "Paddle Court",
      icon: "/images/radiant-waves/amenities/PaddleCourt.png",
    },
    {
      name: "Fitness Hub",
      icon: "/images/radiant-waves/amenities/FitnessHub.png",
    },
    {
      name: "Kids Play Area",
      icon: "/images/radiant-waves/amenities/KidsPlayArea.png",
    },
    {
      name: "Public Terrace",
      icon: "/images/radiant-waves/amenities/PublicTerrace.png",
    },
    {
      name: "Ample Parking",
      icon: "/images/radiant-waves/amenities/AmpleParking.png",
    ...
    //   icon: "/images/radiant-waves/amenities/Outdoor_Fitness_Area.webp",
    // },
    // {
    //   name: "Padel Courts",
    //   icon: "/images/radiant-waves/amenities/Padel_Courts.webp",
    // },
    // {
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#0c1a2a] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#0c1a2a] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#0c1a2a] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#0c1a2a]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors relative z-20"
          >

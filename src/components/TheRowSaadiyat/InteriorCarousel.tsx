...
export default function InteriorCarousel() {
  ...
  const images = [
    "/images/the-row/The_Row_Saadiyat_1.jpg",
    "/images/the-row/The_Row_Saadiyat_Interior_1.jpg",
    "/images/the-row/The_Row_Saadiyat_4.jpg",
    "/images/the-row/The_Row_Saadiyat_Interior_2.jpg",
    "/images/the-row/The_Row_Saadiyat_7.jpg",
    "/images/the-row/The_Row_Saadiyat_Interior_1.jpg",
  ];

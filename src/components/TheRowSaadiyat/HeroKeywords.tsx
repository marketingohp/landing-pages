  ...
  const keywords = [
    {
      ...
      url: "/images/the-row/The_Row_Saadiyat_6.jpg",
    },
    {
      wordKey: "hero.energy",
      taglineKey: "hero.tagline",
      url: "/images/the-row/The_Row_Saadiyat_2.jpg",
    },
    {
      wordKey: "hero.energy",
      taglineKey: "hero.tagline",
      url: "/images/the-row/The_Row_Saadiyat_3.jpg",
    },
    {
      wordKey: "hero.energy",
      taglineKey: "hero.tagline",
      url: "/images/the-row/The_Row_Saadiyat_4.jpg",
    },
    {
      wordKey: "hero.energy",
      taglineKey: "hero.tagline",
      url: "/images/the-row/The_Row_Saadiyat_1.jpg",
    },
    {
      wordKey: "hero.energy",
      taglineKey: "hero.tagline",
      url: "/images/the-row/The_Row_Saadiyat_5.jpg",
    },
  ];

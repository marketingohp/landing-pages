  ...
  const amenities = [
    {
      ...
      icon: "/images/the-row/amenities/Boutique_Stores.png",
    },
    {
      name: "Cafes",
      icon: "/images/the-row/amenities/Cafes.png",
    },
    {
      name: "Co-working Spaces",
      icon: "/images/the-row/amenities/Co-working_Spaces.png",
    },
    {
      name: "Fitness Centre",
      icon: "/images/the-row/amenities/Fitness_Centre.png",
    },
    {
      name: "Pet Spa and Grooming",
      icon: "/images/the-row/amenities/Pet_Spa_and_Grooming.png",
    },
    {
      name: "Restaurants",
      icon: "/images/the-row/amenities/Restaurants.png",
    },
    {
      name: "Supermarket",
      icon: "/images/the-row/amenities/Supermarket.png",
    },
    {
      name: "Working Space",
      icon: "/images/the-row/amenities/Working_Space.png",
    },
    // {
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#00392a] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#00392a] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#00392a] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#00392a]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors relative z-20"
          >

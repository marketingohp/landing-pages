...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "Swimming Pool",
      icon: "/images/tara-park-by-modon/amenities/swimming_pool.png",
    },
    {
      name: "Padel Court",
      icon: "/images/tara-park-by-modon/amenities/padel_court.png",
    },
    {
      name: "Children's Playroom",
      icon: "/images/tara-park-by-modon/amenities/children_playroom.png",
    },
    {
      name: "Shaded Garden Lounge",
      icon: "/images/tara-park-by-modon/amenities/garden.png",
    },
    {
      name: "Coworking & Study Zone",
      icon: "/images/tara-park-by-modon/amenities/coworking.png",
    },
    {
      name: "Communal Dining Lounge",
      icon: "/images/tara-park-by-modon/amenities/dining_lounge.png",
    },
    {
      name: "Outdoor Workspaces",
      icon: "/images/tara-park-by-modon/amenities/coworking.png",
    },
    {
      name: "Mutli-Sports Court",
      icon: "/images/tara-park-by-modon/amenities/sports_court.png",
    },
    {
      name: "Gym",
      icon: "/images/tara-park-by-modon/amenities/gym.png",
    },
    {
      name: "Yoga Studio",
      icon: "/images/tara-park-by-modon/amenities/yoga_studio.png",
    },
  ];

  ...
  return (
    <section className="py-20 lg:py-32 bg-[#050708]/90 dark:bg-[#0a0a0a] relative">
      <div className="absolute inset-0 opacity-20 dark:opacity-20">
        <Image
          src="/images/tara-park-by-modon/interior/MODON_TARAPARK_BROCHURE_260305_FIN-34.png"
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="order-2 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <div
              className="text-[#ffffff] dark:text-[#AC7B58] text-7xl md:text-8xl lg:text-9xl font-bold mb-4 font-mobile-payment-plan2"
              style={{ fontFamily: "Abril Fatface, serif" }}
            >
              50/50
            </div>
            <div
              className="text-white dark:text-[#fff] text-xl md:text-2xl lg:text-3xl tracking-wider  font-mobile-payment-plan3"
            ...
            <div className="overflow-hidden">
              <table className="w-full text-white border-collapse">
                <thead>
                  <tr>
                    <th
                      className=" text-center pb-5 font-semibold text-sm md:text-base tracking-wider border-b border-[#d4af37]/50 text-[#ffffff] dark:text-[#AC7B58]"

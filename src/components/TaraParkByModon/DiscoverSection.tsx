...
export default function DiscoverSection() {
  ...
  const destinations = [
    ...
    {
      time: "5 MINUTES",
      icon: "/images/tara-park-by-modon/locations/adgm.png",
      destination: "ADGM & The Galleria Mall ",
    },
    {
      time: "5 MINUTES",
      icon: "/images/tara-park-by-modon/locations/downtown_abu_dhabi.png",
      destination: "Downtown Abu Dhabi",
    },
    {
      time: "15 MINUTES",
      icon: "/images/tara-park-by-modon/locations/louvre_abu_dhabi.png",
      destination: "Louvre Abu Dhabi",
    },
    // Row 2
    {
      time: "23 MINUTES",
      icon: "/images/tara-park-by-modon/locations/disneyland.png",
      destination: "Disneyland Abu Dhabi",
    },
    {
      time: "25 MINUTES",
      icon: "/images/tara-park-by-modon/locations/zayed_airport.png",
      destination: "Zayed International Airport",
    },
    {
      time: "90 MINUTES",
      icon: "/images/tara-park-by-modon/locations/downtown_dubai.png",
        ...
        <div className="max-w-7xl mx-auto mb-8 sm:mb-10 md:mb-12">
          <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
            ...
            <div className="order-1 lg:order-2">
              <div className="bg-white dark:bg-[#57432A] rounded-lg p-4 sm:p-5 md:p-6 shadow-lg">
                {/* Title */}
                ...
                <div className="relative mb-3 sm:mb-4">
                  ...
                  >
                    <Image
                      src="images/tara-park-by-modon/tara_park_map.png"
                      alt="Location Map"
                      fill

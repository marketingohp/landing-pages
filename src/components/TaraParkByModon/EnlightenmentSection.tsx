    ...
    >
      <div className="container mx-auto py-10 px-4 lg:px-8">
        <div className="text-center mb-12">
          <h2
            className="text-2xl md:text-4xl lg:text-5xl text-[#57432A] dark:text-white mb-8"
        ...
        <div className="text-center">
          {/* <p className="text-base sm:text-lg text-[#57432A] dark:text-gray-300 max-w-4xl mx-auto mb-8 sm:mb-10 md:mb-12 px-2">
            {t("royal.enlightenment.desc2")}
          </p> */}
          <button
            onClick={handleClickOpen}
            className="bg-[#57432A] dark:bg-[#57432A] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#050708]/80 dark:hover:bg-[#050708]/80 transition-colors"
          >
            {t("form.register")}
          </button>
        </div>

...
export default function InteriorCarousel() {
  ...
  const images = [
    "/images/fay-hills/fay_hills_1.webp",
    "/images/fay-hills/fay_hills_2.webp",
    "/images/fay-hills/fay_hills_3.webp",
    "/images/fay-hills/fay_hills_4.webp",
    "/images/fay-hills/fay_hills_5.webp",
  ];

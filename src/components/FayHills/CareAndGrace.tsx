...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "Kids Pool",
      icon: "/images/fay-hills/amenities/Kids Pool.webp",
    },
    {
      name: "Gymnasium",
      icon: "/images/fay-hills/amenities/Gym.webp",
    },
    {
      name: "Yoga Court",
      icon: "/images/fay-hills/amenities/Yoga Court.webp",
    },
    {
      name: "Spa & Sauna",
      icon: "/images/fay-hills/amenities/Spa & Sauna.webp",
    },
    {
      name: "Running Track",
      icon: "/images/fay-hills/amenities/Running Track.webp",
    },
    {
      name: "Amphitheatre",
      icon: "/images/fay-hills/amenities/Amphitheatre.webp",
    },
    {
      name: "Parks and Leisure Areas",
      icon: "/images/fay-hills/amenities/Parks and Leisure Areas.webp",
    },
    {
      name: "Tennis Courts",
      icon: "/images/fay-hills/amenities/Tennis Courts.webp",
    },
    // {
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#5f602c] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#5f602c] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#5f602c] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#5f602c]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors relative z-20"
          >

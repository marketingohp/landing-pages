      ...
      <nav className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between py-4">
          ...
          >
            ...
            >
              <img
                src="/images/fay-hills/fay_hill_logo.webp"
                width={100}
                height={60}
                style={{ width: "50px" }}
                alt="one residences"
            ...
            <div
              className={`text-xs lg:text-sm font-sans uppercase tracking-wider transition-colors duration-300 ${
                isScrolled
                  ? "text-[#5f602c]/80 dark:text-gray-300"
                  : "text-[#5f602c]/80 dark:text-gray-300"
              }`}
            >
              {t("royal.tagline")}
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${
                isScrolled
                  ? "text-[#5f602c] dark:text-gray-100 hover:bg-[#5f602c]/10 dark:hover:bg-gray-800/50"
                  : "text-[#5f602c] dark:text-gray-100 hover:bg-white/10 dark:hover:bg-gray-800/50"
              }`}

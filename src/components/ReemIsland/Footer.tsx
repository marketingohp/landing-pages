...
export default function Footer() {
  const { t } = useLanguage();
  return (
    <footer className="relative py-20 lg:py-32 bg-[#2296c4] dark:bg-[#0f1f2e] text-white">
          ...
          <div className="space-y-6 flex flex-col items-center justify-center text-center">
            <div>
              ...
              >
                <img
                  ...
                  width={100}
                  height={60}
                  style={{ width: "200px", stroke: "white" }}
                  alt="one residences"
                />
              </div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <p className="text-xs opacity-70 mt-8">
                Copyright © 2025 Reem Island. All rights reserved.
              </p>
            </div>

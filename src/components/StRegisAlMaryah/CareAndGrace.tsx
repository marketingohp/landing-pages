...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "Boutique Spa",
      icon: "/images/stregis-al-maryah/amenities/BoutiqueSpa.png",
    },
    {
      name: "Fitness Centre",
      icon: "/images/stregis-al-maryah/amenities/FitnessCentre.png",
    },
    {
      name: "Indoor Cinema",
      icon: "/images/stregis-al-maryah/amenities/IndoorCinema.png",
    },

    {
      name: "Laundry Services",
      icon: "/images/stregis-al-maryah/amenities/LaundryServices.png",
    },
    {
      name: "Library",
      icon: "/images/stregis-al-maryah/amenities/Library.png",
    },

    {
      name: "Short Golf Course",
      icon: "/images/stregis-al-maryah/amenities/ShortGolfCourse.png",
    },

    {
      name: "Squash Courts",
      icon: "/images/stregis-al-maryah/amenities/SquashCourts.png",
    },
    {
      name: "Treatment Room",
      icon: "/images/stregis-al-maryah/amenities/TreatmentRoom.png",
    },
  ];
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#064851] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#064851] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#064851] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#064851]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors relative z-20"
          >

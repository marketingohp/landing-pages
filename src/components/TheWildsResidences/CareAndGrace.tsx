...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "Muga Court",
      icon: "/images/the-wilds-residences/amenities/MugaCourt.png", 
    },
    {
      name: "Cycle Track",
      icon: "/images/the-wilds-residences/amenities/CycleTrack.png",
    },
    {
      name: "The Spring - Splash Pad",
      icon: "/images/the-wilds-residences/amenities/TheSpringSplashPad.png",
    },
    {
      name: "Yoga Deck",
      icon: "/images/the-wilds-residences/amenities/YogaDeck.png",
    },
    {
      name: "Health Club",
      icon: "/images/the-wilds-residences/amenities/HealthClub.png",
    },
    {
      name: "The Studio - Dance & Yogas",
      icon: "/images/the-wilds-residences/amenities/TheStudioDanceYoga.png",
    },
    {
      name: "Sanctuary Spa",
      icon: "/images/the-wilds-residences/amenities/SanctuarySpo.png",
    },
    {
      name: "Community Garden",
      icon: "/images/the-wilds-residences/amenities/CommunityGarden.png",
    },

    {
      name: "Beekeeping",
      icon: "/images/the-wilds-residences/amenities/Beekeeping.png",
    },
  ];
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#585f2a] dark:text-white mb-8 capitalize"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#585f2a] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#585f2a] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#585f2a]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors relative z-20"
          >

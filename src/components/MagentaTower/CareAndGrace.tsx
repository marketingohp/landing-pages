...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "24x7 Security",
      icon: "/images/magenta-tower/amenities/24x7_Security.png",
    },
    {
      name: "Amusement",
      icon: "/images/magenta-tower/amenities/Amusement_Park.png",
    },
    {
      name: "Basketball Court",
      icon: "/images/magenta-tower/amenities/Basketball_Court.png",
    },
    {
      name: "Cycling Trails ",
      icon: "/images/magenta-tower/amenities/Cycling_Trails.png",
    },
    {
      name: "Dining Outlets",
      icon: "/images/magenta-tower/amenities/Dining_Outlets.png",
    },
    {
      name: "Fitness Center",
      icon: "/images/magenta-tower/amenities/Fitness_Centre.png",
    },
    {
      name: "Green Surrounding",
      icon: "/images/magenta-tower/amenities/Green_Surrounding.png",
    },
    {
      name: "Gymnasium",
      icon: "/images/magenta-tower/amenities/Gymnasium.png",
    },

    {
      name: "Kids Play Area",
      icon: "/images/magenta-tower/amenities/kids_play_Area.png",
    },
    {
      name: "Indoor Parking",
      icon: "/images/magenta-tower/amenities/Indoor_Parking.png",
    },
    {
      name: "Jogging Trails",
      icon: "/images/magenta-tower/amenities/Jogging_Trails.png",
    },
    {
      name: "Parking Facility",
      icon: "/images/magenta-tower/amenities/Parking_Facility.png",
    },
    {
      name: "Parks and Leisure Areas",
      icon: "/images/magenta-tower/amenities/Parks_and_Leisure_Areas.png",
    },
    {
      name: "Restaurants",
      icon: "/images/magenta-tower/amenities/Restaurants.png",
    },
    {
      name: "Supermarket",
      icon: "/images/magenta-tower/amenities/Supermarket.png",
    },
    {
      name: "Swimming Pool",
      icon: "/images/magenta-tower/amenities/Swimming_Pool.png",
    },
  ];
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-5xl text-[#642d5b] dark:text-white mb-8 capitalize"
            style={{ fontFamily: "var(--font-playfair), serif" }}
          >
            {t("royal.care.title")}
          </h2>
          <p className="text-base sm:text-lg text-[#642d5b] dark:text-gray-300 max-w-5xl mx-auto mb-8 sm:mb-10 md:mb-12 px-2">
            {t("royal.care.desc")}
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#642d5b] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#642d5b] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#642d5b]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors relative z-20"
          >

    ...
    >
      <div className="container mx-auto py-10 px-4 lg:px-8">
        ...
        {/* <div className="max-w-5xl mx-auto mb-8">
          <div className="relative aspect-video rounded-lg overflow-hidden bg-[#642d5b] dark:bg-[#2a4a6c]">
            <video
              width="1200"
              height="600"
        ...
        <div className="text-center">
          {/* <p className="text-base sm:text-lg text-[#642d5b] dark:text-gray-300 max-w-4xl mx-auto mb-8 sm:mb-10 md:mb-12 px-2">

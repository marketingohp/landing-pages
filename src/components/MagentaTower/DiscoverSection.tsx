...
export default function DiscoverSection() {
  ...
  const destinations = [
    ...
    {
      time: "10 MINUTES",
      icon: "/images/magenta-tower/location/Global_Village.png",
      destination: "Glbal Village",
    },
    {
      time: "30 MINUTES",
      icon: "/images/magenta-tower/location/Iconic_Burj_Khalifa.png",
      destination: "Iconic Burj Khalifa ",
    },
    {
      time: "30 MINUTES",
      icon: "/images/magenta-tower/location/Jumeirah_Beach.png",
      destination: "Jumeirah Beach",
    },
    // Row 2
    {
      time: "20 MINUTES",
      icon: "/images/magenta-tower/location/Mall_of_the_Emirates.png",
      destination: "Mall of the Emirates",
    },
    {
      time: "40 MINUTES",
      icon: "/images/magenta-tower/location/The_Palm.png",
      destination: "The Palm",
    },
    {
      time: "25 MINUTES",
      icon: "/images/magenta-tower/location/Dubai_International_Airport.png",
    ...
    <section className="py-12 sm:py-16 md:py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <h2
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#642d5b] dark:text-white mb-4 sm:mb-6 md:mb-8 capitalize"
            style={{ fontFamily: "var(--font-playfair), serif" }}
            dangerouslySetInnerHTML={{ __html: t("royal.discover.title") }}
          ></h2>
          <p className="text-base sm:text-lg text-[#642d5b] dark:text-gray-300 max-w-6xl mx-auto mb-8 sm:mb-10 md:mb-12 px-2">
          ...
          <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
              ...
              <div className="grid grid-cols-2 sm:hidden gap-4">
                {destinations.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="text-[#642d5b] dark:text-white font-bold text-xs mb-0.5">
                      {item.destination}
                    </div>
                    <div className="text-[#642d5b] dark:text-gray-400 text-[10px] leading-tight">
                      {item.time}
                    </div>
                  </div>
                ))}
              ...
              <div className="hidden sm:grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                {destinations.map((item, index) => (
                  ...
                  >
                    ...
                    {/* Destination */}
                    <div className="text-[#642d5b] dark:text-white font-bold text-sm md:text-base mb-1">
                      {item.destination}
                    </div>
                    <div className="text-[#642d5b] dark:text-gray-400 text-xs md:text-sm leading-tight px-1">
                      {item.time}
                    </div>
                  </div>
                ))}
            ...
            <div className="order-1 lg:order-2">
              <div className="shadow-lg">
                {/* Title */}
                {/* <h3 className="text-[#642d5b] dark:text-white font-bold text-sm sm:text-base md:text-lg lg:text-xl mb-4 sm:mb-5 md:mb-6 uppercase tracking-wide text-center lg:text-left leading-tight sm:leading-normal">
                ...
                <div className="relative mb-3 sm:mb-4">
                  <div
                    className="relative aspect-video rounded-lg overflow-hidden bg-[#642d5b] dark:bg-[#2a4a6c] cursor-pointer hover:opacity-90 transition-opacity duration-300"
                    onClick={handleMapImageClick}
                  >
                    <Image
                      src="/images/magenta-tower/magenta_location.webp"
                      alt="Location Map"
                      fill
                      className="object-contain img-map"
                      unoptimized
                    />
        ...
        <div className="text-center">
          <button
            ...
            className="bg-[#642d5b] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#642d5b]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors"
          >
                  ...
                  <SwiperSlide key={index}>
                    <div className="relative w-full h-[600px] md:h-[700px] lg:h-[800px] overflow-hidden">
                      ...
                      <div className="absolute inset-0">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-br from-[#642d5b]/80 via-[#642d5b]/60 to-[#642d5b]/80 dark:from-[#0a0a0a]/90 dark:via-[#1a1a1a]/80 dark:to-[#2a4a6c]/90"></div>
          ...
          >
            ...
            <div className="relative w-full h-full">
              <Image
                ...
                width={1920}
                height={1080}
                className="w-full h-auto max-h-[90vh] object-contain img-map rounded-lg"
                unoptimized
              />

...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "Beach Access",
      icon: "/images/wadeem/amenities/Beach_Access.png",
    },
    {
      name: "Cycling Trails",
      icon: "/images/wadeem/amenities/Cycling_Trails.png",
    },
    {
      name: "Fitness Centre",
      icon: "/images/wadeem/amenities/Fitness_Centre.png",
    },
    {
      name: "Gymnasium",
      icon: "/images/wadeem/amenities/Gymnasium.png",
    },
    {
      name: "Health Care Centre",
      icon: "/images/wadeem/amenities/Health_Care_Centre.png",
    },
    {
      name: "Kids Play Area",
      icon: "/images/wadeem/amenities/Kids_Play_Area.png",
    },
    {
      name: "Parks and Leisure Areas",
      icon: "/images/wadeem/amenities/Parks_and_Leisure_Areas.png",
    },
    {
      name: "Running Track",
      icon: "/images/wadeem/amenities/Running_Track.png",
    },
    // {
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#475e4c] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#475e4c] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#475e4c] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#475e4c]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors relative z-20"
          >

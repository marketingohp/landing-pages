...
export default function InteriorCarousel() {
  ...
  const images = [
    "/images/wadeem/Wadeem_HUD_6.jpg",
    "/images/wadeem/Wadeem_HUD_7.jpg",
    "/images/wadeem/Wadeem_HUD_8.jpg",
    "/images/wadeem/Wadeem_HUD_9.jpg",
    "/images/wadeem/Wadeem_HUD_10.jpg",
  ];

  ...
  const amenities = [
    {
      ...
      icon: "/images/four-seasons/amenities/Directbeachaccess.png",
    },
    {
      name: "Swimming Pools & Poolside Spaces",
      icon: "/images/four-seasons/amenities/Swimmingpools_poolsidespaces.png",
    },
    {
      name: "Residents Lounge",
      icon: "/images/four-seasons/amenities/Residentslounge.png",
    },
    {
      name: "Spa & Treatment Rooms",
      icon: "/images/four-seasons/amenities/Spa_treatmentrooms.png",
    },
    {
      name: "Yoga & Meditation Studio",
      icon: "/images/four-seasons/amenities/Yoga_meditationstudio.png",
    },
    {
      name: "Tennis & Padel Courts",
      icon: "/images/four-seasons/amenities/Tennis_padelcourts.png",
    },
    {
      name: "Children indoor and outdoor play areas",
      icon: "/images/four-seasons/amenities/Childrensindoorandoutdoorplayareas.png",
    },
    {
      name: "Fitness Center & Studio",
      icon: "/images/four-seasons/amenities/Fitnesscenter_studio.png",
    },
  ];
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#ad8a63] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#ad8a63] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#ad8a63] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#ad8a63]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors relative z-20"
          >

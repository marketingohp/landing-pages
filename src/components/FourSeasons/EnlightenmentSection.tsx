    ...
    >
      <div className="container mx-auto py-10 px-4 lg:px-8">
        <div className="text-center mb-12">
          <h2
            className="text-2xl md:text-4xl lg:text-5xl text-[#ad8a63] dark:text-white mb-8"
        ...
        <div className="max-w-5xl mx-auto mb-8">
          <div className="relative aspect-video rounded-lg overflow-hidden bg-[#ad8a63] dark:bg-[#2a4a6c]">
            <video
              width="1200"
              height="600"
              ...
              muted
            >
              <source src="/images/flow-25/four-seasonsVido.mp4" type="video/mp4" />
            </video>
          </div>
        </div>

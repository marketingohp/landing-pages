          ...
          >
            <div
              className={`text-3xl lg:text-4xl transition-colors duration-300 ${
                isScrolled
                  ? "text-[#ad8a63] dark:text-gray-100"
                  : "text-[#ad8a63] dark:text-gray-100"
              }`}
              style={{ fontFamily: "var(--font-playfair), serif" }}
            >
              <img
                src="/images/four-seasons/four_seasons_logo_1.png"
                width={100}
                height={60}
                style={{ width: "100px" }}
                alt="one residences"
            ...
            <div
              className={`text-xs lg:text-sm font-sans uppercase tracking-wider transition-colors duration-300 ${
                isScrolled
                  ? "text-[#ad8a63]/80 dark:text-gray-300"
                  : "text-[#ad8a63]/80 dark:text-gray-300"
              }`}
            >
              {/* {t("royal.tagline")} */}
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${
                isScrolled
                  ? "text-[#ad8a63] dark:text-gray-100 hover:bg-[#ad8a63]/10 dark:hover:bg-gray-800/50"
                  : "text-[#ad8a63] dark:text-gray-100 hover:bg-white/10 dark:hover:bg-gray-800/50"
              }`}

...
export default function InteriorCarousel() {
  ...
  const images = [
    "/images/bashayer/bashayer_residences_12.webp",
    "/images/bashayer/bashayer_residences_9.webp",
    "/images/bashayer/bashayer_residences_11.webp",
    "/images/bashayer/bashayer_residences_8.webp",
    "/images/bashayer/bashayer_residences_3.webp",
  ];

...
import { useLanguage } from "@/contexts/yasRivaResidences/LanguageContext";
            ...
            <div className="flex flex-col md:hidden space-y-4">
              ...
              <div className="px-4 py-3 text-center border-b border-[#064851] dark:border-gray-400 border-opacity-30">
                <div className="text-[#064851] dark:text-white font-normal text-sm leading-relaxed">
                  LOCATION: <br /> Yas Island, Abu Dhabi
                </div>
              </div>
              ...
              <div className="px-4 py-3 text-center border-b border-[#064851] dark:border-gray-400 border-opacity-30">
                <div className="text-[#064851] dark:text-white font-normal text-sm leading-relaxed">
                  Unit Type <br /> 1-3BR Apartments & 4-6BR Villas
                </div>
              </div>
              ...
              <div className="px-4 py-3 text-center">
                <div className="text-[#064851] dark:text-white font-normal text-sm leading-relaxed">
                  Lifestyle:
                  <br />
                  Resort-style waterfront
                  <br />
                  living centered on wellness.
                </div>
              </div>
            </div>

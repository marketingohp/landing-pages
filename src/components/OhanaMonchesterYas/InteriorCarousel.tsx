...
export default function InteriorCarousel() {
  ...
  const images = [
    "/images/ohana/interior/manchester_interior_1.webp",
    "/images/ohana/interior/manchester_interior_2.webp",
    "/images/ohana/interior/manchester_interior_3.webp",
    "/images/ohana/interior/manchester_interior_4.webp",
    "/images/ohana/interior/manchester_interior_5.webp",
  ];

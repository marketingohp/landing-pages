  ...
  const amenities = [
    {
      ...
      icon: "/images/ohana/amenities/football_acadmay.webp",
    },
    {
      name: "Sports Complex",
      icon: "/images/ohana/amenities/sports_complex.webp",
    },
    {
      name: "Wellness & Recovery",
      icon: "/images/ohana/amenities/wellness.webp",
    },
    {
      name: "Lesure & Culture",
      icon: "/images/ohana/amenities/leasire_culture.webp",
    },
    // {
    //   name: "Comunity Hall",
    //   icon: "/images/ohana/amenities/Community_Halls.png",
    // },
    // {
    //   name: "Retail Outlets",
    //   icon: "/images/ohana/amenities/Retail_Outlets.png",
    // },
    // {
    //   name: "Kids Play Area",
    //   icon: "/images/ohana/amenities/Kids_Play_Area.png",
    // },
    // {
    //   name: "F & B Outlets",
    //   icon: "/images/ohana/amenities/F_B_Outlets.png",
    // },
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#001340] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#001340] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
                  ...
                  <SwiperSlide key={index}>
                    <div className="relative w-full h-[600px] md:h-[700px] lg:h-[800px] overflow-hidden">
                      ...
                      <div className="absolute inset-0">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-br from-[#001340]/80 via-[#001340]/60 to-[#001340]/80 dark:from-[#0a0a0a]/90 dark:via-[#1a1a1a]/80 dark:to-[#2a4a6c]/90"></div>

...
export default function DiscoverSection() {
  ...
  const destinations = [
    {
      time: "5 MINUTES",
      icon: "/images/fahid-beach-house-by-aldar/locations/yas_island.png",
      destination: "Yas Island",
    },
    {
      time: "15 MINUTES",
      icon: "/images/fahid-beach-house-by-aldar/locations/saadiyat_island.png",
      destination: "Saadiyat Island",
    },
    {
      time: "15 MINUTES",
      icon: "/images/fahid-beach-house-by-aldar/locations/zayed_international_airport.png",
      destination: "Zayed International Airport ",
    },
    {
      time: "20 MINUTES",
      icon: "/images/fahid-beach-house-by-aldar/locations/abu_dhabi.png",
      destination: "Abu Dhabi City",
    },
    {
      time: "50 MINUTES",
      icon: "/images/fahid-beach-house-by-aldar/locations/dubai.png",
      destination: "Dubai",
    },
  ];
    ...
    <section className="py-12 sm:py-16 md:py-20 lg:py-32 bg-[#FCFCF9] dark:bg-[#1a1a1a]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <h2
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#327675] dark:text-white mb-4 sm:mb-6 md:mb-8"
            style={{ fontFamily: "var(--font-playfair), serif" }}
            dangerouslySetInnerHTML={{ __html: t("royal.discover.title") }}
          ></h2>
          <p className="text-base sm:text-lg text-[#327675] dark:text-white max-w-5xl mx-auto mb-8 sm:mb-10 md:mb-12 px-2">
          ...
          <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="grid grid-cols-2 sm:hidden gap-4">
                {destinations.map((item, index) => (
                  ...
                  >
                    {/* Icon Circle */}
                    <div className="w-20 h-20 md:w-24 md:h-24 mb-3 rounded-full bg-[#327675] dark:bg-[#05565A] flex items-center justify-center shadow-md overflow-hidden hover:scale-110 transition-transform duration-300">
                      <img
                        src={item.icon}
                        width={50}
                        height={50}
                    ...
                    <div className="text-[#327675] dark:text-white font-bold text-xs mb-0.5">
                      {item.destination}
                    </div>
                    <div className="text-[#327675] dark:text-white text-[10px] leading-tight">
                      {item.time}
                    </div>
                  </div>
                ))}
              ...
              <div className="hidden sm:grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                {destinations.map((item, index) => (
                  ...
                  >
                    ...
                    {/* Destination */}
                    <div className="text-[#327675] dark:text-white font-bold text-sm md:text-base mb-1">
                      {item.destination}
                    </div>
                    <div className="text-[#327675] dark:text-white text-xs md:text-sm leading-tight px-1">
                      {item.time}
                    </div>
                  </div>
                ))}
            ...
            <div className="order-1 lg:order-2">
              <div className="bg-white dark:bg-[#050708] rounded-lg p-4 sm:p-5 md:p-6 shadow-lg">
                {/* Title */}
                {/* <h3 className="text-[#327675] dark:text-white font-bold text-sm sm:text-base md:text-lg lg:text-xl mb-4 sm:mb-5 md:mb-6 uppercase tracking-wide text-center lg:text-left leading-tight sm:leading-normal">
                ...
                <div className="relative mb-3 sm:mb-4">
                  ...
                  >
                    <Image
                      src="images/fahid-beach-house-by-aldar/fahid_map.webp"
                      alt="Location Map"
                      fill

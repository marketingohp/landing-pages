...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "Swimming Pools",
      icon: "/images/fahid-beach-house-by-aldar/amenities/swimming_pool.svg",
    },
    {
      name: "Gymnasiums",
      icon: "/images/fahid-beach-house-by-aldar/amenities/fitness.svg",
    },
    {
      name: "Multipurpose Rooms",
      icon: "/images/fahid-beach-house-by-aldar/amenities/studio.svg",
    },
    {
      name: "Children's Play Areas",
      icon: "/images/fahid-beach-house-by-aldar/amenities/kids_play.svg",
    },
    {
      name: "Co-Working Lounges",
      icon: "/images/fahid-beach-house-by-aldar/amenities/studio.svg",
    },
    {
      name: "Community Zones",
      icon: "/images/fahid-beach-house-by-aldar/amenities/community_center.svg",
    },
    {
      name: "Bicycle Parking Station",
      icon: "/images/fahid-beach-house-by-aldar/amenities/landscape_garden.svg",
    },
  ];

  return (
    <section className="py-20 lg:py-32 bg-[[#327675]] dark:bg-[#[#05565A]] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#327675] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities?.map((amenity, index) => (
            ...
            >
              <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-[#327675] dark:bg-[#05565A] flex items-center justify-center shadow-lg text-4xl hover:scale-110 transition-transform duration-300">
                <img
                  src={amenity.icon}
                  width={60}
                  height={60}
              ...
              <p className="text-[#327675] dark:text-white text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#327675] dark:bg-[#05565A] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#05565A]/80 dark:hover:bg-[#05565A]/80 transition-colors relative z-20"
          >

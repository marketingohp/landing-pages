  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-[9999] transition-all duration-300 ${
        isScrolled
          ? "bg-white/95 dark:bg-[#158592]/95 backdrop-blur-md shadow-lg"
          : "bg-[#ebe8dd] dark:bg-[#158592]/80 dark:backdrop-blur-md"
      }`}
    >
      <nav className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between py-4">
          ...
          >
            ...
            >
              <img
                src="/images/ramhan-island-by-eagle-hills/rahman_island_logo_black.png"
                width={200}
                height={200}
                style={{ width: "140px" }}
                alt="Ramhan Island by Eagle Hills"
              />
            </div>
            <div
              className={`text-xs lg:text-sm font-sans uppercase tracking-wider transition-colors duration-300 ${
                isScrolled
                  ? "text-zinc-800/80 dark:text-gray-300"
                  : "text-zinc-800/80 dark:text-gray-300"
              }`}
            >
              {/* {t("royal.tagline")} */}
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${
                isScrolled
                  ? "text-zinc-800 dark:text-gray-100 hover:bg-[#00314a]/10 dark:hover:bg-gray-800/50"
                  : "text-zinc-800 dark:text-gray-100 hover:bg-white/10 dark:hover:bg-gray-800/50"
              }`}

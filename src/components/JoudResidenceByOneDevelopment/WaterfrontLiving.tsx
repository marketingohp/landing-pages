...
export default function WaterfrontLiving() {
  ...
  return (
    <section
      className="relative py-20 lg:py-10 bg-[#F9FBFF] dark:bg-[#1a1a1a]"
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8">
        <div className="text-center mb-5">
          <h2
            className="text-2xl md:text-4xl lg:text-5xl text-[#2C3E5F] dark:text-white mb-6"
          ...
          >
            ...
            <div className="hidden md:flex md:flex-wrap md:items-center md:justify-center gap-0 min-w-max">
              ...
              <div className="flex-1 min-w-[200px] px-6 md:px-8 py-4 text-center">
                {/* <div className="text-[#2C3E5F] dark:text-white font-bold text-sm md:text-base mb-1 uppercase tracking-wide">
                  LOCATION:
                </div>
              ...
              <div className="flex-1 min-w-[200px] px-6 md:px-8 py-4 text-center">
                ...
                <div className="text-[#2C3E5F] dark:text-white font-normal text-sm md:text-base"></div> */}
                <div className="text-[#2C3E5F] dark:text-white font-normal text-sm md:text-base leading-relaxed">
                  By <br /> One Development
                </div>
              </div>
        ...
        {/* <div className="grid grid-cols-3 md:grid-cols-6 gap-8 mb-12">
          {travelTimes.map((item, index) => (
            <div key={index} className="text-center">
              ...
              <div className="text-[#2C3E5F] dark:text-white font-bold text-lg mb-2">
                {item.time}
              </div>
              <div className="text-[#2C3E5F] dark:text-gray-400 text-sm">
                {item.destination}
              </div>
            </div>
          ))}

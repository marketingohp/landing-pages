...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "Urban Drone Taxi Access",
      icon: "/images/joud-residence-by-one-development/amenities/drone_taxi.png",
    },
    {
      name: "Drone Delivery System",
      icon: "/images/joud-residence-by-one-development/amenities/drone_delivery.png",
    },
    {
      name: "Hyperbaric Oxygen Therapy (HBOT)",
      icon: "/images/joud-residence-by-one-development/amenities/hbot.png",
    },
    {
      name: "Outdoor Kids Playground",
      icon: "/images/joud-residence-by-one-development/amenities/kids_playarea.png",
    },
    {
      name: "Infinity Swimming pool",
      icon: "/images/joud-residence-by-one-development/amenities/infinity_pool.png",
    },
    {
      name: "Sports Court",
      icon: "/images/joud-residence-by-one-development/amenities/sports_court.png",
    },
    {
      name: "Indoor & Outdoor Gym",
      icon: "/images/joud-residence-by-one-development/amenities/gym.png",
    },
    {
      name: "Outdoor Cinema",
      icon: "/images/joud-residence-by-one-development/amenities/outdoor_cinema.png",
    },
    {
      name: "Wellness spa with sauna",
      icon: "/images/joud-residence-by-one-development/amenities/spa.png",
    },
    {
      name: "BBQ Area",
      icon: "/images/joud-residence-by-one-development/amenities/bbq.png",
    },
    {
      name: "Jogging Track",
      icon: "/images/joud-residence-by-one-development/amenities/jogging_track.png",
    },
    {
      name: "Sunken Majlis",
      icon: "/images/joud-residence-by-one-development/amenities/sunken_majlis.png",
    },
  ];

  return (
    <section className="py-20 lg:py-32 bg-[[#2C3E5F]] dark:bg-[#[#2C3E5F]] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#2C3E5F] dark:text-white mb-8"
            style={{ fontFamily: "var(--font-playfair), serif" }}
          >
            {t("royal.care.title")}
          </h2>
          <p className="text-base sm:text-lg text-[#2C3E5F] dark:text-white max-w-5xl mx-auto mb-8 sm:mb-10 md:mb-12 px-2">
            {t("royal.care.desc")}
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities?.map((amenity, index) => (
            ...
            >
              <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-[#2C3E5F] dark:bg-[#2C3E5F] flex items-center justify-center shadow-lg text-4xl hover:scale-110 transition-transform duration-300">
                <img
                  src={amenity.icon}
                  width={160}
                  height={160}
              ...
              <p className="text-[#2C3E5F] dark:text-white text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#2C3E5F] dark:bg-[#2C3E5F] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#02215E]/80 dark:hover:bg-[#02215E]/80 transition-colors relative z-20"
          >

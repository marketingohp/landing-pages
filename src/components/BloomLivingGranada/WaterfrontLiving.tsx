...
export default function WaterfrontLiving() {
  ...
  return (
    <section
      className="relative py-20 lg:py-10 bg-[#FFFEFB] dark:bg-[#1a1a1a]"
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8">
        <div className="text-center mb-5">
          <h2
            className="text-2xl md:text-4xl lg:text-5xl text-[#AA8B6A] dark:text-white mb-6"
            style={{ fontFamily: "var(--font-playfair), serif" }}
            dangerouslySetInnerHTML={{ __html: t("royal.waterfront.title") }}
          ></h2>

          {/* <div className="max-w-8xl mx-auto space-y-4 text-[#AA8B6A] dark:text-gray-300 text-4xl py-2">
            <p
              className="custom-mobile-display-style1"
              dangerouslySetInnerHTML={{ __html: t("royal.waterfront.desc2") }}
            ></p>
          </div> */}
          <div className="max-w-5xl mx-auto space-y-4 text-[#AA8B6A] dark:text-white text-lg py-4">
            <p
          ...
          >
            ...
            <div className="flex flex-col md:hidden space-y-4">
              ...
              <div className="px-4 py-3 text-center border-b border-[#00314a] dark:border-gray-400 border-opacity-30">
                <div className="text-[#AA8B6A] dark:text-white font-normal text-sm leading-relaxed">
                  LOCATION: <br /> Zayed City, Abu Dhabi
                </div>
              </div>
              ...
              <div className="px-4 py-3 text-center border-b border-[#00314a] dark:border-gray-400 border-opacity-30">
                <div className="text-[#AA8B6A] dark:text-white font-normal text-sm leading-relaxed">
                  Unit Type <br />  1 – 3BR apartments, and Studios.
                </div>
              </div>
            ...
            <div className="hidden md:flex md:flex-wrap md:items-center md:justify-center gap-0 min-w-max">
              ...
              <div className="flex-1 min-w-[200px] px-6 md:px-8 py-4 text-center">
                {/* <div className="text-[#AA8B6A] dark:text-white font-bold text-sm md:text-base mb-1 uppercase tracking-wide">
                  LOCATION:
                </div>
              ...
              <div className="flex-1 min-w-[200px] px-6 md:px-8 py-4 text-center">
                ...
                <div className="text-[#AA8B6A] dark:text-white font-normal text-sm md:text-base"></div> */}
                <div className="text-[#AA8B6A] dark:text-white font-normal text-sm md:text-base leading-relaxed">
                  By <br /> Bloom Properties
                </div>
              </div>
        ...
        {/* <div className="grid grid-cols-3 md:grid-cols-6 gap-8 mb-12">
          {travelTimes.map((item, index) => (
            <div key={index} className="text-center">
              ...
              <div className="text-[#AA8B6A] dark:text-white font-bold text-lg mb-2">
                {item.time}
              </div>
              <div className="text-[#AA8B6A] dark:text-gray-400 text-sm">
                {item.destination}
              </div>
            </div>
          ))}

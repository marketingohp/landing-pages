...
export default function WaterfrontLiving() {
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8">
        <div className="text-center mb-5">
          <h2
            className="text-2xl md:text-4xl lg:text-5xl text-[#000000] dark:text-white mb-6 leading-normal"
            style={{ fontFamily: "var(--font-playfair), serif" }}
            dangerouslySetInnerHTML={{ __html: t("royal.waterfront.title") }}
          ></h2>

          <div className="max-w-8xl mx-auto space-y-4 text-[#000000] dark:text-gray-300 text-4xl py-2">
            <p
              className="custom-mobile-display-style1"
              dangerouslySetInnerHTML={{ __html: t("royal.waterfront.title2") }}
            ></p>
          </div>
          <div className="max-w-5xl mx-auto space-y-4 text-[#000000] dark:text-gray-300 text-lg py-4">
            <p
 ...
 {/* Vertical Separator */}
              ...
              {/* 4 BEDROOM DUPLEXES AND TOWNHOUSES */}
              <div className="flex-1 min-w-[200px] px-6 md:px-8 py-4 text-center">
                {/* <div className="text-[#000000] dark:text-white font-bold text-sm md:text-base mb-1 uppercase tracking-wide">
        ...
        {/* <div className="grid grid-cols-3 md:grid-cols-6 gap-8 mb-12">
          {travelTimes.map((item, index) => (
            <div key={index} className="text-center">
              ...
              <div className="text-[#000000] dark:text-white font-bold text-lg mb-2">
                {item.time}
              </div>
              <div className="text-[#000000] dark:text-gray-400 text-sm">
                {item.destination}
              </div>
            </div>
          ))}

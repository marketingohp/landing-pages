...
export default function DiscoverSection() {
  ...
  const destinations = [
    ...
    {
      time: "10 MINUTES",
      icon: "/images/athlon/location/Global_Village.png",
      destination: "Glbal Village",
    },
    {
      time: "30 MINUTES",
      icon: "/images/athlon/location/Iconic_Burj_Khalifa.png",
      destination: "Iconic Burj Khalifa ",
    },
    {
      time: "30 MINUTES",
      icon: "/images/athlon/location/Jumeirah_Beach.png",
      destination: "Jumeirah Beach",
    },
    // Row 2
    {
      time: "20 MINUTES",
      icon: "/images/athlon/location/Mall_of_the_Emirates.png",
      destination: "Mall of the Emirates",
    },
    {
      time: "40 MINUTES",
      icon: "/images/athlon/location/The_Palm.png",
      destination: "The Palm",
    },
    {
      time: "25 MINUTES",
      icon: "/images/athlon/location/Dubai_International_Airport.png",
            ...
            <div className="order-1 lg:order-2">
              <div className="shadow-lg">
                ...
                <div className="relative mb-3 sm:mb-4">
                  ...
                  >
                    <Image
                      src="/images/athlon/athlon-location-map.jpg"
                      alt="Location Map"
                      fill

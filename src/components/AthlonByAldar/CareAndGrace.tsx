  ...
  const amenities = [
    {
      ...
      icon: "/images/athlon/amenities/Basketball_Court.png",
    },
    {
      name: "BBQ Areas",
      icon: "/images/athlon/amenities/BBQ_Areas.png",
    },
    {
      name: "Beach",
      icon: "/images/athlon/amenities/Beach.png",
    },
    {
      name: "Beach Access",
      icon: "/images/athlon/amenities/Beach_Access.png",
    },
    {
      name: "Circket Pitch",
      icon: "/images/athlon/amenities/Cricket_Pitch.png",
    },
    {
      name: "Cycling Trails",
      icon: "/images/athlon/amenities/Fitness_Centre.png",
    },
    {
      name: "Dining Outles",
      icon: "/images/athlon/amenities/Dining_Outlets.png",
    },
    {
      name: "Dog Park",
      icon: "/images/athlon/amenities/Dog_Park.png",
    },
    ...
    {
      name: "Gymnasium",
      icon: "/images/athlon/amenities/Gymnasium.png",
    },
    {
      name: "Health Care Center",
      icon: "/images/athlon/amenities/Health_Care_Centre.png",
    },
    {
      name: "Housekeeping",
      icon: "/images/athlon/amenities/Housekeeping.png",
    },
    {
      name: "Indoor Games",
      icon: "/images/athlon/amenities/Indoor_Games.png",
    },
    {
      name: "Indoor Playground",
      icon: "/images/athlon/amenities/Indoor_Playground.png",
    },
    {
      name: "Infinity Pool",
      icon: "/images/athlon/amenities/Infinity_Pool.png",
    },
    {
      name: "Jogging Tracks",
      icon: "/images/athlon/amenities/Jogging_Tracks.png",
    },
  ];

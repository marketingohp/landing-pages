  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-[9999] transition-all duration-300 ${
        isScrolled
          ? "bg-white/95 dark:bg-[#9C7A45]/95 backdrop-blur-md shadow-lg"
          : "bg-[#ebe8dd] dark:bg-[#9C7A45]/80 dark:backdrop-blur-md"
      }`}
    >
          ...
          >
            <div
              className={`text-3xl lg:text-4xl transition-colors duration-300 ${
                isScrolled
                  ? "text-[#9C7A45] dark:text-gray-100"
                  : "text-[#9C7A45] dark:text-gray-100"
              }`}
              style={{ fontFamily: "var(--font-playfair), serif" }}
            >
              <img
                src="/images/sobha-city/sobha_logo_black.png"
                width={200}
                height={200}
                style={{ width: "100px" }}
                alt="Sobha City"
            ...
            <div
              className={`text-xs lg:text-sm font-sans uppercase tracking-wider transition-colors duration-300 ${
                isScrolled
                  ? "text-[#9C7A45]/80 dark:text-gray-300"
                  : "text-[#9C7A45]/80 dark:text-gray-300"
              }`}
            >
              {/* {t("royal.tagline")} */}
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${
                isScrolled
                  ? "text-[#9C7A45] dark:text-gray-100 hover:bg-[#00314a]/10 dark:hover:bg-gray-800/50"
                  : "text-[#9C7A45] dark:text-gray-100 hover:bg-white/10 dark:hover:bg-gray-800/50"
              }`}

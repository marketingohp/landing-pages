...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "Dining Outlets",
      icon: "/images/seamont-autograph/amenities/DiningOutlets.png",
    },
    {
      name: "Gymnasium",
      icon: "/images/seamont-autograph/amenities/Gymnasium.png",
    },
    {
      name: "Indoor Outdoor Childerns Play Area",
      icon: "/images/seamont-autograph/amenities/IndoorOutdoorChildrensPlayAreas.png",
    },
    {
      name: "Kids Pool",
      icon: "/images/seamont-autograph/amenities/KidsPool.png",
    },
    {
      name: "Multi Purpose Lounge",
      icon: "/images/seamont-autograph/amenities/MultiPurposeLounge.png",
    },
    {
      name: "Sauna",
      icon: "/images/seamont-autograph/amenities/Sauna.png",
    },
    {
      name: "Supermarket",
      icon: "/images/seamont-autograph/amenities/Supermarket.png",
    },
    {
      name: "Swimming Pool",
      icon: "/images/seamont-autograph/amenities/SwimmingPool.png",
    },
    // {
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#001a38] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#001a38] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#001a38] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#001a38]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors relative z-20"
          >

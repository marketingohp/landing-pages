...
export default function InteriorCarousel() {
  ...
  const images = [
    "/images/seamont-autograph/seamont_autograph10.jpg",
    "/images/seamont-autograph/seamont_autograph3.jpg",
    "/images/seamont-autograph/seamont_autograph5.jpg",
    "/images/seamont-autograph/seamont_autograph7.jpg",
    "/images/seamont-autograph/seamont_autograph8.jpg",
  ];

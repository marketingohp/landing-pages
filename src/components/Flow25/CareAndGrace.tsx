  ...
  const amenities = [
    {
      ...
      icon: "/images/flow-25/amenities/SwimmingPools.png",
    },
    {
      name: "Fitness Center",
      icon: "/images/flow-25/amenities/FitnessCenter.png",
    },
    {
      name: "Rooftop Yoga Pavilion",
      icon: "/images/flow-25/amenities/RooftopYogaPavilion.png",
    },
    {
      name: "Smart Home System",
      icon: "/images/flow-25/amenities/SmartHomeSystem.png",
    },
    {
      name: "Residents Lounge",
      icon: "/images/flow-25/amenities/ResidentsLounge.png",
    },
    {
      name: "Outdoor Kids Play Area",
      icon: "/images/flow-25/amenities/OutdoorKidsPlayArea.png",
    },
    {
      name: "Retail Podium",
      icon: "/images/flow-25/amenities/RetailPodium.png",
    },
    {
      name: "Cinema Room",
      icon: "/images/flow-25/amenities/CinemaRoom.png",
    },
    // {
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#3c3c3b] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#3c3c3b] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#3c3c3b] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#3c3c3b]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors relative z-20"
          >

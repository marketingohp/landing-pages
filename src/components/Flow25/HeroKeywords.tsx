  ...
  const keywords = [
    {
      ...
      url: "/images/flow-25/flow251.jpg",
    },
    {
      wordKey: "hero.energy",
      taglineKey: "hero.tagline",
      url: "/images/flow-25/flow252.jpg",
    },
    {
      wordKey: "hero.energy",
      taglineKey: "hero.tagline",
      url: "/images/flow-25/flow253.jpg",
    },
    {
      wordKey: "hero.energy",
      taglineKey: "hero.tagline",
      url: "/images/flow-25/flow259.jpg",
    },
    {
      wordKey: "hero.energy",
      taglineKey: "hero.tagline",
      url: "/images/flow-25/flow255.jpg",
    },
  ];

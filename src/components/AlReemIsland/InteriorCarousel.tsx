...
export default function InteriorCarousel() {
  ...
  const images = [
    "/images/al-reem-island/Al-Reem-Island-06.webp",
    "/images/al-reem-island/Al-Reem-Island-08.webp",
    "/images/al-reem-island/Al-Reem-Island-07.webp",
    "/images/al-reem-island/Al-Reem-Island-09.webp",
  ];

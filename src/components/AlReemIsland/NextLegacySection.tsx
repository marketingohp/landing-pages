...
export default function NextLegacySection() {
  return (
    <section
      className="relative min-h-screen flex items-center justify-center overflow-hidden next-legacy-section"
      // style={{
      //   paddingTop: "200px",
      //   paddingBottom: "200px",
      // }}
    >
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-8xl mx-auto">
        ...
        <p className="text-lg montserrat-regular md:text-xl lg:text-2xl text-white mb-4 md:mb-6 leading-relaxed font-light">
          Connect with us to discover an elite portfolio of waterfront
          masterpieces tailored to your ambition.
        </p>

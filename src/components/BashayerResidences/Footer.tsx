...
export default function Footer() {
  const { t } = useLanguage();
  return (
    <footer className="relative py-20 lg:py-32 bg-[#3f4973] dark:bg-[#0f1f2e] text-white">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-12">
          ...
          <div className="space-y-6 flex flex-col items-center justify-center text-center">
            <div>
              ...
              >
                <img
                  src="/images/bashayer/Bashayer_LogoWhite.webp"
                  width={100}
                  height={60}
                  style={{ width: "200px" }}
                  alt="one residences"
            ...
            <div className="space-y-2 text-sm">
              ...
              <p className="text-xs opacity-70 mt-8">
                Copyright © 2025 Bashayer Residences. All rights reserved.
              </p>
            </div>

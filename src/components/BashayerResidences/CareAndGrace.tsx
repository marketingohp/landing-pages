  ...
  const amenities = [
    {
      ...
      icon: "/images/bashayer/amenities/Indoor_Outdoor_Gym.webp",
    },
    {
      name: "Main Pol & Sun Deck",
      icon: "/images/bashayer/amenities/Main_Pol_Sun_Deck.webp",
    },
    {
      name: "Kid’s Pool",
      icon: "/images/bashayer/amenities/Kid's_Pool.webp",
    },
    {
      name: "Outdoor Kids’ Play Area",
      icon: "/images/bashayer/amenities/Outdoor_Kids'_Play_Area.webp",
    },
    {
    ...
    {
      name: "BBQ Area",
      icon: "/images/bashayer/amenities/BBQ_Area.webp",
    },
    {
      name: "Dog Park",
      icon: "/images/bashayer/amenities/Dog_Park.webp",
    },
    {
      name: "Indoor Club Lounge",
      icon: "/images/bashayer/amenities/Indoor_Club_Lounge.webp",
    },
    // {
    //   name: "Outdoor Kids Playground",
    //   icon: "/images/amenities_nearby/Outdoor_Kids_Playground.webp",
    // },
  ];
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#3f4973] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#3f4973] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#3f4973] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#3f4973]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors relative z-20"
          >

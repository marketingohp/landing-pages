  ...
  const amenities = [
    {
      ...
      icon: "/images/rotana-reem/amenities/FullyEquippedFitnessCenter.png",
    },
    {
      name: "Outdoor Swimming Pool",
      icon: "/images/rotana-reem/amenities/OutdoorSwimmingPool.png",
    },
    {
      name: "Padel Court",
      icon: "/images/rotana-reem/amenities/PadelCourt.png",
    },
    {
      name: "Kids Pool",
      icon: "/images/rotana-reem/amenities/KidsPool.png",
    },
    {
      name: "Kids Play Area",
      icon: "/images/rotana-reem/amenities/KidsPlayArea.png",
    },
    {
      name: "Landscaped Outdoor Areas",
      icon: "/images/rotana-reem/amenities/landscapedOutdoorAreas.png",
    },
    {
      name: "Lawn Areas",
      icon: "/images/rotana-reem/amenities/LawnAreas.png",
    },
    {
      name: "BBQ Area",
      icon: "/images/rotana-reem/amenities/BBQArea.png",
    },
    {
      name: "Jogging Track",
      icon: "/images/rotana-reem/amenities/JoggingTrack.png",
    },
  ];
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#213b65] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#213b65] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#213b65] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#213b65]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors relative z-20"
          >

...
export default function CareAndGrace() {
  ...
  {
    name: "Pearl Beach",
    icon: "/images/tilal-binghatti/amenities/beach.png"
  },
  {
    name: "clubhouse",
    icon: "/images/tilal-binghatti/amenities/clubhouse.png"
  },
  {
    name: "wellness zones,",
    icon: "/images/tilal-binghatti/amenities/wellness_center.png"
  },
  {
    name: "nursery & kids areas",
    icon: "/images/tilal-binghatti/amenities/kids_playarea.png"
  },
  {
    name: "clinics",
    icon: "/images/tilal-binghatti/amenities/clinic.png"
  },
  {
    name: "mosque",
    icon: "/images/tilal-binghatti/amenities/mosque.png"
  },
  {
    name: "jogging & cycling tracks",
    icon: "/images/tilal-binghatti/amenities/jogging_track.png"
  },
  {
    name: "sports courts",
    icon: "/images/tilal-binghatti/amenities/sports_court.png"
  },
  {
    name: "EV charging",
    icon: "/images/tilal-binghatti/amenities/ev_station.png"
  },
  {
    name: "restaurants & coffee shops",
    icon: "/images/tilal-binghatti/amenities/restuarant.png"
  }
];

  return (
    <section className="py-20 lg:py-32 bg-[[#636035]] dark:bg-[#[#636035]] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#636035] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities?.map((amenity, index) => (
            ...
            >
              <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-[#636035] dark:bg-[#636035] flex items-center justify-center shadow-lg text-4xl hover:scale-110 transition-transform duration-300">
                <img
                  src={amenity.icon}
                  width={60}
                  height={60}
              ...
              <p className="text-[#636035] dark:text-white text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#636035] dark:bg-[#636035] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#B7AD66]/80 dark:hover:bg-[#B7AD66]/80 transition-colors relative z-20"
          >

...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "Infinity Pool at 30 Meters ",
      icon: "/images/bloom-arjaan/amenities/pool.webp",
    },
    {
      name: "Modern Gym & Fitness Center ",
      icon: "/images/bloom-arjaan/amenities/fitness.webp",
    },
    {
      name: "Children’s Play Area",
      icon: "/images/bloom-arjaan/amenities/playarea.webp",
    },
    {
      name: "On-Site Cafés & Restaurants",
      icon: "/images/bloom-arjaan/amenities/cafe.webp",
    },
    {
      name: "Retail Outlets",
      icon: "/images/bloom-arjaan/amenities/retail.webp",
    },
    {
      name: "Covered Parking ",
      icon: "/images/bloom-arjaan/amenities/parking.webp",
    },
    {
      name: "24/7 Security & CCTV ",
      icon: "/images/bloom-arjaan/amenities/cctv.webp",
    },
    {
      name: "Dog Park",
      icon: "/images/bloom-arjaan/amenities/dog.webp",
    },
    // {

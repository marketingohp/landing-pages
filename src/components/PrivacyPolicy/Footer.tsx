...
export default function Footer() {
  const { t } = useLanguage();
  return (
    <footer className="relative py-20 lg:py-32 bg-[#1a3a5c] dark:bg-[#0f1f2e] text-white">
      <div className="absolute inset-0 opacity-30 dark:opacity-20">
        {/* <img
          src="/images/bloom-arjaan/bloom_arjaan_logo.webp"
          width={100}
          height={60}
          style={{ width: "180px" }}pp
          alt="one residences"
        /> */}
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-12">
          ...
          <div className="space-y-6 flex flex-col items-center justify-center text-center">
            <div>
              ...
              >
                <img
                  src="/images/bloom-arjaan/bloom_arjaan_logo(1).png"
                  width={100}
                  height={60}
                  style={{ width: "500px" }}
                  alt="one residences"
            ...
            <div className="space-y-2 text-sm">
              ...
              <p className="text-xs opacity-70 mt-8">
                Copyright © 2025 Bloom Arjaan by Rotana. All rights reserved.
              </p>
            </div>

...
import { useLanguage } from "@/contexts/bloomArjaanByRotana/LanguageContext";
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8">
        <div className="text-center mb-5">
          <h2
            className="text-2xl md:text-4xl lg:text-5xl text-[#1a3a5c] dark:text-white mb-6"
        ...
        <div className="list-box-style1 mb-5">
          ...
          >
            ...
            <div className="flex flex-col md:hidden space-y-4">
              {/* LOCATION */}
              <div className="px-4 py-3 text-center border-b border-[#1a3a5c] dark:border-gray-400 border-opacity-30">
                <div className="text-[#1a3a5c] dark:text-white font-normal text-sm leading-relaxed">
                  Unit Types: <br /> Studios-2BR Apartments, and Townhouses.
                </div>
              </div>
              ...
              <div className="px-4 py-3 text-center border-b border-[#1a3a5c] dark:border-gray-400 border-opacity-30">
                <div className="text-[#1a3a5c] dark:text-white font-normal text-sm leading-relaxed">
                  Unit Sizes: <br /> from 477 - 1,225 Sqft.
                </div>
              </div>
            ...
            <div className="hidden md:flex md:flex-wrap md:items-center md:justify-center gap-0 min-w-max">
              ...
              <div className="flex-1 min-w-[200px] px-6 md:px-8 py-4 text-center">
                {/* <div className="text-[#1a3a5c] dark:text-white font-bold text-sm md:text-base mb-1 uppercase tracking-wide">
                  LOCATION:
                </div>
                <div className="text-[#1a3a5c] dark:text-white font-normal text-sm md:text-base leading-relaxed">
                  Al Reem ISLAND
                </div> */}
                <div className="text-[#1a3a5c] dark:text-white font-normal text-sm md:text-base leading-relaxed">
                  Unit Types: <br /> Studios-2BR Apartments, and Townhouses.
              ...
              {/* Vertical Separator */}
              <div className="w-px h-20 bg-[#1a3a5c] dark:bg-gray-400 opacity-30"></div>
              ...
              <div className="flex-1 min-w-[200px] px-6 md:px-8 py-4 text-center">
                ...
                <div className="text-[#1a3a5c] dark:text-white font-normal text-sm md:text-base">
                  Q4 2028
                </div> */}
                <div className="text-[#1a3a5c] dark:text-white font-normal text-sm md:text-base leading-relaxed">
                  Unit Sizes: <br /> from 477 - 1,225 Sqft.
              ...
              <div className="flex-1 min-w-[200px] px-6 md:px-8 py-4 text-center">
                <div className="text-[#1a3a5c] dark:text-white font-normal text-sm md:text-base leading-relaxed">
                  Starting Price: <br /> From AED 800,000
                </div>
              </div>
              ...
              <div className="flex-1 min-w-[200px] px-6 md:px-8 py-4 text-center">
                ...
                <div className="text-[#1a3a5c] dark:text-white font-normal text-sm md:text-base"></div> */}
                <div className="text-[#1a3a5c] dark:text-white font-normal text-sm md:text-base leading-relaxed">
                  Developer: <br /> Bloom Holding
                </div>
              </div>
        ...
        {/* <div className="grid grid-cols-3 md:grid-cols-6 gap-8 mb-12">
          {travelTimes.map((item, index) => (
            <div key={index} className="text-center">
              ...
              <div className="text-[#1a3a5c] dark:text-white font-bold text-lg mb-2">
                {item.time}
              </div>
              <div className="text-[#4a6fa5] dark:text-gray-400 text-sm">
                {item.destination}
              </div>
            </div>
          ))}

          ...
          >
            <div
              className={`text-3xl lg:text-4xl transition-colors duration-300 ${
                isScrolled
                  ? "text-[#1a3a5c] dark:text-gray-100"
                  : "text-white dark:text-gray-100"
              }`}
              style={{ fontFamily: "var(--font-playfair), serif" }}
            >
              <img
                src="/images/bloom-arjaan/bloom_arjaan_logo.webp"
                width={100}
                height={60}
                style={{ width: "180px" }}
                alt="one residences"
            ...
            <div
              className={`text-xs lg:text-sm font-sans uppercase tracking-wider transition-colors duration-300 ${
                isScrolled
                  ? "text-[#1a3a5c]/80 dark:text-gray-300"
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${
                isScrolled
                  ? "text-[#1a3a5c] dark:text-gray-100 hover:bg-[#1a3a5c]/10 dark:hover:bg-gray-800/50"

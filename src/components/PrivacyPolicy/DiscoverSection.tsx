...
export default function DiscoverSection() {
  ...
  const destinations = [
    ...
    {
      time: "5 MINUTES",
      icon: "/images/bloom-arjaan/location/Saadiyat Beach.webp",
      destination: "Saadiyat Beach",
    },
    {
      time: "7 MINUTES",
      icon: "/images/bloom-arjaan/location/Saadiyat Beach Golf Club.webp",
      destination: "Saadiyat Beach Golf Club",
    },
    {
      time: "22 MINUTES",
      icon: "/images/bloom-arjaan/location/Tamara Polyclinics LLC.webp",
      destination: "Tamara Polyclinics LLC",
    },
    // Row 2
    {
      time: "30 MINUTES",
      icon: "/images/bloom-arjaan/location/The Louvre Abu Dhabi.webp",
      destination: "The Louvre Abu Dhabi",
    },
    {
      time: "20 MINUTES",
      icon: "/images/bloom-arjaan/location/Downtown Abu Dhabi.webp",
      destination: "Downtown Abu Dhabi",
    },
    {
      time: "25 MINUTES",
      icon: "/images/bloom-arjaan/location/Zayed International Airport 1.webp",
            ...
            <div className="order-1 lg:order-2">
              <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-5 md:p-6 shadow-lg">
                ...
                <div className="relative mb-3 sm:mb-4">
                  ...
                  >
                    <Image
                      src="images/bloom-arjaan/bloom-arjanlocation.webp"
                      alt="Location Map"
                      fill

...
export default function DiscoverSection() {
  ...
  const destinations = [
    ...
    {
      time: "5 MINUTES",
      icon: "/images/a1la-residences/location/ReemHospitalReemMall.png",
      destination: "Reem Hospital & Reem Mall.",
    },
    {
      time: "7 MINUTES",
      icon: "/images/a1la-residences/location/GalleriaMallAbuDhabiGlobalMarketADGM.png",
      destination: "Galleria Mall & Abu Dhabi Global Market (ADGM)",
    },
    // Row 2
    {
      time: "10 MINUTES",
      icon: "/images/a1la-residences/location/AbuDhabiCityCenter.png",
      destination: "Abu Dhabi City Center",
    },
    {
      time: "25 MINUTES",
      icon: "/images/a1la-residences/location/ZayedInternationalAirport.png",
    ...
    <section className="py-12 sm:py-16 md:py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <h2
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#a77b55] dark:text-white mb-4 sm:mb-6 md:mb-8 capitalize"
          ...
          <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
              ...
              <div className="grid grid-cols-2 sm:hidden gap-4">
                {destinations.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="text-[#a77b55] dark:text-white font-bold text-xs mb-0.5">
                      {item.destination}
                    </div>
                    <div className="text-[#a77b55] dark:text-gray-400 text-[10px] leading-tight">
                      {item.time}
                    </div>
                  </div>
                ))}
              ...
              <div className="hidden sm:grid sm:grid-cols-2 md:grid-cols-2 gap-4 md:gap-6">
                {destinations.map((item, index) => (
                  ...
                  >
                    ...
                    {/* Destination */}
                    <div className="text-[#a77b55] dark:text-white font-bold text-sm md:text-base mb-1">
                      {item.destination}
                    </div>
                    <div className="text-[#a77b55] dark:text-gray-400 text-xs md:text-sm leading-tight px-1">
                      {item.time}
                    </div>
                  </div>
                ))}
            ...
            <div className="order-1 lg:order-2">
              <div className="bg-white dark:bg-gray-800 rounded-lg p-0 sm:p-0 md:p-0 shadow-lg">
                {/* Title */}
                {/* <h3 className="text-[#a77b55] dark:text-white font-bold text-sm sm:text-base md:text-lg lg:text-xl mb-4 sm:mb-5 md:mb-6 uppercase tracking-wide text-center lg:text-left leading-tight sm:leading-normal">
                ...
                <div className="relative mb-3 sm:mb-4">
                  <div
                    className="relative aspect-video rounded-lg overflow-hidden bg-[#a77b55] dark:bg-[#2a4a6c] cursor-pointer hover:opacity-90 transition-opacity duration-300"
                    onClick={handleMapImageClick}
                  >
                    <Image
                      src="/images/a1la-residences/A1LA-LocatonMap.jpg"
                      alt="Location Map"
                      fill
                  ...
                  <SwiperSlide key={index}>
                    <div className="relative w-full h-[600px] md:h-[700px] lg:h-[800px] overflow-hidden">
                      ...
                      <div className="absolute inset-0">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-br from-[#a77b55]/80 via-[#a77b55]/60 to-[#a77b55]/80 dark:from-[#0a0a0a]/90 dark:via-[#1a1a1a]/80 dark:to-[#2a4a6c]/90"></div>

          ...
          >
            <div
              className={`text-3xl lg:text-4xl transition-colors duration-300 ${
                isScrolled
                  ? "text-[#a77b55] dark:text-gray-100"
                  : "text-[#a77b55] dark:text-gray-100"
              }`}
              style={{ fontFamily: "var(--font-playfair), serif" }}
            >
              <img
                src="/images/a1la-residences/A1LA-logo.png"
                width={100}
                height={100}
                style={{ width: "140px" }}
                alt="one residences"
            ...
            <div
              className={`text-xs lg:text-sm font-sans uppercase tracking-wider transition-colors duration-300 ${
                isScrolled
                  ? "text-[#a77b55]/80 dark:text-gray-300"
                  : "text-[#a77b55]/80 dark:text-gray-300"
              }`}
            >
              {/* {t("royal.tagline")} */}
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${
                isScrolled
                  ? "text-[#a77b55] dark:text-gray-100 hover:bg-[#a77b55]/10 dark:hover:bg-gray-800/50"
                  : "text-[#a77b55] dark:text-gray-100 hover:bg-white/10 dark:hover:bg-gray-800/50"
              }`}

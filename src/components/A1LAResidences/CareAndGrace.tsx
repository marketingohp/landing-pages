...
export default function CareAndGrace() {
  ...
  const amenities = [
    ...
    {
      name: "Gym",
      icon: "/images/a1la-residences/amenities/gym.png",
    },
    {
      name: "Yoga & Pilates",
      icon: "/images/a1la-residences/amenities/YogaPilates.png",
    },
    {
      name: "Swimming Pool",
      icon: "/images/a1la-residences/amenities/SwimmingPool.png",
    },
    {
      name: "Outdoor Sport",
      icon: "/images/a1la-residences/amenities/OutdoorSport.png",
    },
    {
      name: "KIDS Pool",
      icon: "/images/a1la-residences/amenities/KIDSPool.png",
    },
    {
      name: "Table Tennis",
      icon: "/images/a1la-residences/amenities/TableTennis.png",
    },
    {
      name: "Cinema",
      icon: "/images/a1la-residences/amenities/Cinema.png",
    },
  ];
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#a77b55] dark:text-white mb-8 capitalize"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#a77b55] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#a77b55] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#a77b55]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors relative z-20"
          >

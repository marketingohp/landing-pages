...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "Dining Outlets",
      icon: "/images/hudayriyat/amenities/Dining_Outlets.webp",
    },
    {
      name: "Beach Access",
      icon: "/images/hudayriyat/amenities/Beach_Access.webp",
    },
    {
      name: "Gymnasium",
      icon: "/images/hudayriyat/amenities/Gymnasium.webp",
    },
    {
      name: "Retail Outlets",
      icon: "/images/hudayriyat/amenities/Retail_Outlets.webp",
    },
    {
      name: "Kids Play Area",
      icon: "/images/hudayriyat/amenities/Kids_Play_Area.webp",
    },
    {
      name: "Parks & Area",
      icon: "/images/hudayriyat/amenities/Parks_&_Area.webp",
    },
    {
      name: "Restaurants",
      icon: "/images/hudayriyat/amenities/Restaurants.webp",
    },
    {
      name: "Swimming Pool",
      icon: "/images/hudayriyat/amenities/Swimming_Pool.webp",
    },
    // {
    //   name: "Running Track",
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#04352b] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#04352b] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#04352b] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#04352b]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors relative z-20"
          >

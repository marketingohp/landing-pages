...
export default function InteriorCarousel() {
  ...
  const images = [
    "/images/hudayriyat/hudaYriyat-Island_2.webp",
    "/images/hudayriyat/hudaYriyat-Island_4.webp",
    "/images/hudayriyat/hudaYriyat-Island_3.webp",
    "/images/hudayriyat/hudaYriyat-Island_6.webp",
    "/images/hudayriyat/hudaYriyat-Island_1.webp",
  ];

...
const budgetOptions = [
  { value: "6000000", label: "10000000" },
  { value: "30000000", label: "40000000" },
  { value: "40000000", label: "60000000" },
];
...
export default function PropertySearchFormFour({
  formName,
  pointName,
  formType,
        ...
        <div className="flex gap-2">
          ...
          >
            <InputLabel id="phone-country-code-label">
              {t("code") || fieldLabels.phoneCountryCode}
            </InputLabel>
            <Select
    ...
    return (
      ...
      >
        ...
        >
          ...
          <MenuItem value="1.5-2m">AED 1.5–2M</MenuItem>
          <MenuItem value="2-4m">AED 2–4M</MenuItem>
          <MenuItem value="4-6m">AED 4–6M</MenuItem>
          <MenuItem value="6-10m">AED 6–10M</MenuItem>
          <MenuItem value="30-40m">AED 30–40M</MenuItem>
          <MenuItem value="40-60m">AED 40–60M</MenuItem>
  ...
  const renderBannerViewLayout = () => (
    <Box className="space-y-4">
      ...
      <Box className="grid grid-cols-1 md:grid-cols-1 gap-6 box-margin-bottom">
      ...
      <Box className="grid grid-cols-1 md:grid-cols-3 gap-4 box-margin-bottom mt-6">
      ...
      <Box className="grid grid-cols-1 md:grid-cols-1 gap-4 box-margin-bottom mt-6 max-w-6xl mx-auto">
  ...
  return (
    <div
      id="enquire-now"
      className={`${getContainerClasses()} ${className} ${classAdd}`}
      style={
        viewType === "image" || viewType === "modal"
          ? {
              backgroundImage:

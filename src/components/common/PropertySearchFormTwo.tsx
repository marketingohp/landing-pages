...
export default function PropertySearchFormTwo({
  formName,
  pointName,
  formType,
  ...
  const getContainerClasses = () => {
    ...
    if (viewType === "banner") {
      return "relative p-6 lg:p-8 banner-form";
    }
    // Default view
  ...
  const getFormWrapperClasses = () => {
    ...
    if (viewType === "banner") {
      return "max-w-8xl mx-auto custom-width-full-banner relative z-10";
    }
  ...
  return (
    ...
    >
      ...
      <style>
        {`
        .custom-width-full-banner{
  max-width: 100% !important;
  width: 100% !important;
  }

  .custom-width-full-banner .css-12layeo{
    padding: 0 !important;
  }
          `}
        </style>

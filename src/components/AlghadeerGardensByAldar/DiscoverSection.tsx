...
export default function DiscoverSection() {
  ...
  const destinations = [
  {
    ...
    icon: "/images/alghadeer-gardens-by-aldar/locations/ghantoot.png",
    destination: "Ghantoot"
  },
  {
    time: "12 MINUTES",
    icon: "/images/alghadeer-gardens-by-aldar/locations/dubai_parks_resorts.png",
    destination: "Dubai Parks & Resorts"
  },
  {
    time: "14 MINUTES",
    icon: "/images/alghadeer-gardens-by-aldar/locations/dubai_industrial_city.png",
    destination: "Dubai Industrial City"
  },
  {
    time: "16 MINUTES",
    icon: "/images/alghadeer-gardens-by-aldar/locations/dwc.png",
    destination: "AL Maktoum International Airport"
  },
  {
    time: "16 MINUTES",
    icon: "/images/alghadeer-gardens-by-aldar/locations/jebel_ali.png",
    destination: "Jebel Ali Port"
  },
  {
    time: "20 MINUTES",
    icon: "/images/alghadeer-gardens-by-aldar/locations/expo.png",
            ...
            <div className="order-1 lg:order-2">
              <div className="bg-white dark:bg-[#050708] rounded-lg p-4 sm:p-5 md:p-6 shadow-lg">
                ...
                <div className="relative mb-3 sm:mb-4">
                  ...
                  >
                    <Image
                      src="images/alghadeer-gardens-by-aldar/alghadeer_map.webp"
                      alt="Location Map"
                      fill

...
export default function CareAndGrace() {
  ...
  const amenities = [
  {
    ...
    icon: "/images/alghadeer-gardens-by-aldar/amenities/community_centre.png"
  },
  {
    name: "Swimming pool",
    icon: "/images/alghadeer-gardens-by-aldar/amenities/swimming_pool.png"
  },
  {
    name: "play area",
    icon: "/images/alghadeer-gardens-by-aldar/amenities/play_area.png"
  },
  {
    name: "backetball court",
    icon: "/images/alghadeer-gardens-by-aldar/amenities/bascketball_court.png"
  },
  {
    name: "tennis court",
    icon: "/images/alghadeer-gardens-by-aldar/amenities/tennis_court.png"
  },
  {
    name: "events lawn",
    icon: "/images/alghadeer-gardens-by-aldar/amenities/event_lawn.png"
  },
  {
    name: "walkways",
    icon: "/images/alghadeer-gardens-by-aldar/amenities/walkways.png"
  },
  {
    name: "planted canopies",
    icon: "/images/alghadeer-gardens-by-aldar/amenities/planted_canopies.png"
  }
];

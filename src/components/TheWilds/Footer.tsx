...
export default function Footer() {
  const { t } = useLanguage();
  return (
    <footer className="relative py-20 lg:py-32 bg-[#766c0d] dark:bg-[#0f1f2e] text-white">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-12">
          ...
          <div className="space-y-6 flex flex-col items-center justify-center text-center">
            <div>
              ...
              >
                <img
                  src="/images/the-wilds/TheWilds-white_logo.png"
                  width={100}
                  height={100}
                  style={{ width: "240px" }}
                  alt="one residences"
            ...
            <div className="space-y-2 text-sm">
              ...
              <p className="text-xs opacity-70 mt-8">
                Copyright © 2025 The Wilds. All rights reserved.
              </p>
            </div>

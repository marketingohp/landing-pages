...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "Cycling Trails",
      icon: "/images/the-wilds/amenities/Cycling_Trails.png",
    },
    {
      name: "Rock Climbing Walls",
      icon: "/images/the-wilds/amenities/Rock_Climbing_Walls.png",
    },
    {
      name: "Multipurpose Plazas",
      icon: "/images/the-wilds/amenities/Multipurpose_Plazas.png",
    },
    {
      name: "Community Halls",
      icon: "/images/the-wilds/amenities/Community_Halls.png",
    },
    {
      name: "Health Clinics",
      icon: "/images/the-wilds/amenities/Health_Clinics.png",
    },
    {
      name: "Retail Outlets",
      icon: "/images/the-wilds/amenities/Retail_Outlets.png",
    },
    {
      name: "Kids Play Areas",
      icon: "/images/the-wilds/amenities/Kids_Play_Area.png",
    },
    {
      name: "F&B Outlets",
      icon: "/images/the-wilds/amenities/F_B_Outlets.png",
    },
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#766c0d] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#766c0d] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#766c0d] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#766c0d]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors relative z-20"
          >

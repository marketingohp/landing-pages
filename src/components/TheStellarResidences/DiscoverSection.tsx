  ...
  const destinations = [
    {
      ...
      icon: "/images/the-stellar-residences/locations/yas_island.png",
      destination: "Yas Water Front",
    },
    {
      time: "7 MINUTES",
      icon: "/images/the-stellar-residences/locations/yas_marina_circuit.png",
      destination: "Yas Marina",
    },
    {
      time: "10 MINUTES",
      icon: "/images/the-stellar-residences/locations/ferrari_world.png",
      destination: "Ferrari World",
    },
    {
      time: "10 MINUTES",
      icon: "/images/the-stellar-residences/locations/disney.png",
      destination: "Disney",
    },
    {
      time: "12 MINUTES",
      icon: "/images/the-stellar-residences/locations/yas_mall.png",
      destination: "Yas Mall",
    },
    {
      time: "12 MINUTES",
      icon: "/images/the-stellar-residences/locations/yas_american_academy.png",
      destination: "Yas American Academy",
    },
  ];
    ...
    <section className="py-12 sm:py-16 md:py-20 lg:py-32 bg-[#FFFEFB] dark:bg-[#1a1a1a]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <h2
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#AA8B6A] dark:text-white mb-4 sm:mb-6 md:mb-8"
          ...
          <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="grid grid-cols-2 sm:hidden gap-4">
                {destinations.map((item, index) => (
                  ...
                  >
                    {/* Icon Circle */}
                    <div className="w-20 h-20 md:w-24 md:h-24 mb-3 rounded-full bg-[#AA8B6A] dark:bg-[#AA8B6A] flex items-center justify-center shadow-md overflow-hidden hover:scale-110 transition-transform duration-300">
                      <img
                        src={item.icon}
                        width={60}
                        height={60}
                    ...
                    <div className="text-[#AA8B6A] dark:text-white font-bold text-xs mb-0.5">
                      {item.destination}
                    </div>
                    <div className="text-[#AA8B6A] dark:text-white text-[10px] leading-tight">
                      {item.time}
                    </div>
                  </div>
                ))}
              ...
              <div className="hidden sm:grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                {destinations.map((item, index) => (
                  ...
                  >
                    ...
                    {/* Destination */}
                    <div className="text-[#AA8B6A] dark:text-white font-bold text-sm md:text-base mb-1">
                      {item.destination}
                    </div>
                    <div className="text-[#AA8B6A] dark:text-white text-xs md:text-sm leading-tight px-1">
                      {item.time}
                    </div>
                  </div>
                ))}
            ...
            <div className="order-1 lg:order-2">
              <div className="bg-white dark:bg-[#050708] rounded-lg p-4 sm:p-5 md:p-6 shadow-lg">
                {/* Title */}
                {/* <h3 className="text-[#AA8B6A] dark:text-white font-bold text-sm sm:text-base md:text-lg lg:text-xl mb-4 sm:mb-5 md:mb-6 uppercase tracking-wide text-center lg:text-left leading-tight sm:leading-normal">
                ...
                <div className="relative mb-3 sm:mb-4">
                  ...
                  >
                    <Image
                      src="images/the-stellar-residences/stellar_map.webp"
                      alt="Location Map"
                      fill

...
export default function Footer() {
  const { t } = useLanguage();
  return (
    <footer className="relative py-20 lg:py-32 bg-[#AA8B6A] dark:bg-[#917B63] text-white">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-12">
          ...
          <div className="space-y-6 flex flex-col items-center justify-center text-center">
            <div>
              ...
              >
                <img
                  src="/images/the-stellar-residences/stellar_logo_white.png"
                  width={100}
                  height={100}
                  style={{ width: "200px" }}
                  alt="The Stellar Residneces By Emirates Developments"
                />
              </div>

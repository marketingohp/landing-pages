  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-[9999] transition-all duration-300 ${
        isScrolled
          ? "bg-black/95 dark:bg-black/95 backdrop-blur-md shadow-lg"
      ...
      <nav className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between py-4">
          ...
          >
            ...
            >
              <img
                src="/images/radission-residences/radisson_residences_logo.webp"
                width={100}
                height={60}
                style={{ width: "180px" }}
                alt="one residences"
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${
                isScrolled
                  ? "text-white dark:text-gray-100 hover:bg-[#1a3a5c]/10 dark:hover:bg-gray-800/50"

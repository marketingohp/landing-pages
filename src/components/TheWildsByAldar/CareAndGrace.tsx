...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "Cycling Trails",
      icon: "/images/the-wilds-by-aldar/amenities/Cycling_Trails.png",
    },
    {
      name: "Rock Climbing Walls",
      icon: "/images/the-wilds-by-aldar/amenities/Rock_Climbing_Walls.png",
    },
    {
      name: "Multipurpose Plazes",
      icon: "/images/the-wilds-by-aldar/amenities/Multipurpose_Plazas.png",
    },
    {
      name: "Spa & Fitness Centers",
      icon: "/images/the-wilds-by-aldar/amenities/Spas,_and_Fitness_Centers.png",
    },
    {
      name: "Comunity Hall",
      icon: "/images/the-wilds-by-aldar/amenities/Community_Halls.png",
    },
    {
      name: "Retail Outlets",
      icon: "/images/the-wilds-by-aldar/amenities/Retail_Outlets.png",
    },
    {
      name: "Kids Play Area",
      icon: "/images/the-wilds-by-aldar/amenities/Kids_Play_Area.png",
    },
    {
      name: "F & B Outlets",
      icon: "/images/the-wilds-by-aldar/amenities/F_B_Outlets.png",
    },
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#766c0d] dark:text-white mb-8 capitalize"

...
export default function DiscoverSection() {
  ...
  const destinations = [
    ...
    {
      time: "5 MINUTES",
      icon: "/images/the-wilds-by-aldar/location/Falconcity_of_Wonders_Dubai.png",
      destination: "Falconcity of Wonders, Dubai",
    },
    {
      time: "8 MINUTES",
      icon: "/images/the-wilds-by-aldar/location/Zayed_University.png",
      destination: "Zayed University  ",
    },
    {
      time: "10 MINUTES",
      icon: "/images/the-wilds-by-aldar/location/Lulu_Hypermarket_Silicon_Oasis.png",
      destination: "Lulu Hypermarket, Silicon Oasis",
    },
    // Row 2
    {
      time: "10 MINUTES",
      icon: "/images/the-wilds-by-aldar/location/IMG_Worlds_of_Adventure.png",
      destination: "IMG Worlds of Adventure",
    },
    {
      time: "10 MINUTES",
      icon: "/images/the-wilds-by-aldar/location/Dubai_International_Airport.png",
      destination: "Dubai International Airport",
    },
    // {
    //   time: "20 MINUTES",
    //   icon: "/images/the-wilds-by-aldar/location/Zayed_Int._Airport.png",
    ...
    <section className="py-12 sm:py-16 md:py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <h2
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#766c0d] dark:text-white mb-4 sm:mb-6 md:mb-8 capitalize"
            ...
            <div className="order-1 lg:order-2">
              <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-5 md:p-6 shadow-lg">
                ...
                <div className="relative mb-3 sm:mb-4">
                  ...
                  >
                    <Image
                      src="/images/the-wilds-by-aldar/The_Wilds_ByAldar_Location.webp"
                      alt="Location Map"
                      fill

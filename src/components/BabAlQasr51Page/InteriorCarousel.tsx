...
export default function InteriorCarousel() {
  ...
  const images = [
    "/images/bab-al-qasr-51/interior/bab_al_qasr_interior_01.webp",
    "/images/bab-al-qasr-51/interior/bab_al_qasr_interior_02.webp",
    "/images/bab-al-qasr-51/interior/bab_al_qasr_interior_03.webp",
    "/images/bab-al-qasr-51/interior/bab_al_qasr_interior_04.webp",
  ];

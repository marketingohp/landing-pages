...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "24x7 Security",
      icon: "/images/bab-al-qasr-51/amenities/24x7_Security.png",
    },
    {
      name: "Gym",
      icon: "/images/bab-al-qasr-51/amenities/GYM.png",
    },
    {
      name: "Gymnasium",
      icon: "/images/bab-al-qasr-51/amenities/Gymnasium.png",
    },
    {
      name: "Private Beach",
      icon: "/images/bab-al-qasr-51/amenities/Private_Beach.png",
    },
    {
      name: "Seating Areas",
      icon: "/images/bab-al-qasr-51/amenities/Seating_Areas.png",
    },
    {
      name: "Swimming Pool",
      icon: "/images/bab-al-qasr-51/amenities/Swimming_Pool.png",
    },
    {
      name: "Kids Play Areas",
      icon: "/images/bab-al-qasr-51/amenities/Kids_Play_Areas.png",
    },
    {
      name: "Landscaping",
      icon: "/images/bab-al-qasr-51/amenities/landscaping.png",
    },
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#6c492b] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#6c492b] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#6c492b] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#6c492b]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors relative z-20"
          >

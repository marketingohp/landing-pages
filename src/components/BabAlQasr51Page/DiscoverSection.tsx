...
import { useLanguage } from "@/contexts/babAlQasr51/LanguageContext";
...
export default function DiscoverSection() {
  ...
  const destinations = [
    // Row 1
    {
      ...
      icon: "/images/bab-al-qasr-51/locations/Sorbonne_University_Abu_Dhabi.png",
      destination: "Sorbonne University Abu Dhabi",
    },
    {
      time: "05 MINUTES",
      icon: "/images/bab-al-qasr-51/locations/Reem_Mall___Galleria_Mall.png",
      destination: " Reem Mall & Galleria Mall ",
    },
    {
      time: "05 MINUTES",
      icon: "/images/bab-al-qasr-51/locations/Cleveland_Clinic_Abu_Dhabi.png",
      destination: " Cleveland Clinic Abu Dhabi",
    },
    // Row 2
    {
      time: "07 MINUTES",
      icon: "/images/bab-al-qasr-51/locations/ADGM_Abu_Dhabi_Global_Market.png",
      destination: "ADGM (Abu Dhabi Global Market)",
    },
    {
      time: "26 MINUTES",
      icon: "/images/bab-al-qasr-51/locations/Abu_Dhabi_Downtown.png",
      destination: "Abu Dhabi Downtown",
    },
    {
      time: "10 MINUTES",
      icon: "/images/bab-al-qasr-51/locations/Zayed_International_Airport.png",
    ...
    <section className="py-12 sm:py-16 md:py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto mb-8 sm:mb-10 md:mb-12">
          <div className="grid lg:grid-cols-1 gap-4 sm:gap-6 md:gap-8 lg:gap-12 justify-center items-center">
      ...
      >
        <PropertySearchForm
          ...
          // brochureUrl="/images/bab-al-qasr-51/Yas_Riva_Residences_Brochure.pdf"

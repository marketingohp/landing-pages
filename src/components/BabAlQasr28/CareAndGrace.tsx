...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "24x7 Security",
      icon: "/images/bab-al-qasr-28/amenities/24x7_Security.png",
    },
    {
      name: "Gym",
      icon: "/images/bab-al-qasr-28/amenities/GYM.png",
    },
    {
      name: "Gymnasium",
      icon: "/images/bab-al-qasr-28/amenities/Gymnasium.png",
    },
    {
      name: "Private Beach",
      icon: "/images/bab-al-qasr-28/amenities/Private_Beach.png",
    },
    {
      name: "Seating Areas",
      icon: "/images/bab-al-qasr-28/amenities/Seating_Areas.png",
    },
    {
      name: "Swimming Pool",
      icon: "/images/bab-al-qasr-28/amenities/Swimming_Pool.png",
    },
    {
      name: "Kids Play Areas",
      icon: "/images/bab-al-qasr-28/amenities/Kids_Play_Areas.png",
    },
    {
      name: "Landscaping",
      icon: "/images/bab-al-qasr-28/amenities/landscaping.png",
    },

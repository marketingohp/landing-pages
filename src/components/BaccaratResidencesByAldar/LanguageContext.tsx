...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Bacarat Residence Saadiyat",
    "royal.waterfront.title2":
      "blends heritage charm with outstanding connectivity",
    "royal.waterfront.desc1":
      "Baccarat Residences Saadiyat introduces a refined collection of luxury homes inspired by the timeless artistry of Baccarat and visionary architecture.",
    ...
    "royal.enlightenment.title": "Designed for a Life Beyond Ordinary",
    "royal.enlightenment.desc":
      "Surrounded by the World’s Most Iconic Museums providing elegant residences to expansive sky villas and penthouses, every space is crafted as a masterpiece of design, light, and coastal living.",
    ...
    "royal.discover.title": "A Rare Address in Saadiyat’s Cultural Core",
    "royal.discover.desc":
      "Located in the prestigious Saadiyat Island Cultural District, the residences sit among world-renowned landmarks including Louvre Abu Dhabi and the future Guggenheim Abu Dhabi.\nThis exceptional setting blends pristine coastline, cultural institutions and refined lifestyle destinations in one of Abu Dhabi’s most sought-after locations.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "Luxury in Every Experience",
    "royal.care.desc":
      "Every amenity at Baccarat Residences Saadiyat is designed with the same attention to detail as the residences, creating moments of comfort, wellbeing and refined living.",

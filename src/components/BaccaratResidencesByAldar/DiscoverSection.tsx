...
import { useLanguage } from "@/contexts/baccaratResidencesByAldar/LanguageContext";
...
export default function DiscoverSection() {
  ...
  const destinations = [
    ...
    {
      time: "2 MINUTES",
      icon: "/images/baccarat-residences-by-aldar/locations/louvre_abu_dhabi.png",
      destination: "Louvre Abu Dhabi",
    },
    {
      time: "3 MINUTES",
      icon: "/images/baccarat-residences-by-aldar/locations/zayed_national_museum.png",
      destination: "Zayed National Museum",
    },
    {
      time: "6 MINUTES",
      icon: "/images/baccarat-residences-by-aldar/locations/natural_history_museum.png",
      destination: "Natural History Museum Abu Dhabi",
    },
    // Row 2
    {
      time: "16 MINUTES",
      icon: "/images/baccarat-residences-by-aldar/locations/reem_mall.png",
      destination: "Al Reem Mall",
    },
    {
      time: "25 MINUTES",
      icon: "/images/baccarat-residences-by-aldar/locations/ferrari_world.png",
      destination: "Ferrari World Yas Island",
    },
    {
      time: "24 MINUTES",
      icon: "/images/baccarat-residences-by-aldar/locations/zayed_airport.png",
    ...
    <section className="py-12 sm:py-16 md:py-20 lg:py-32 bg-[#FFF9F3] dark:bg-[#1a1a1a]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <h2
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#978A7B] dark:text-white mb-4 sm:mb-6 md:mb-8"
            style={{ fontFamily: "var(--font-playfair), serif" }}
            dangerouslySetInnerHTML={{ __html: t("royal.discover.title") }}
          ></h2>
          <p className="text-base sm:text-lg text-[#978A7B] dark:text-gray-300 max-w-5xl mx-auto mb-8 sm:mb-10 md:mb-12 px-2">
        ...
        <div className="max-w-7xl mx-auto mb-8 sm:mb-10 md:mb-12">
          <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
              ...
              <div className="grid grid-cols-2 sm:hidden gap-4">
                {destinations.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="text-[#978A7B] dark:text-white font-bold text-xs mb-0.5">
                      {item.destination}
                    </div>
                    <div className="text-[#978A7B] dark:text-gray-400 text-[10px] leading-tight">
                      {item.time}
                    </div>
                  </div>
                ))}
              ...
              <div className="hidden sm:grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                {destinations.map((item, index) => (
                  ...
                  >
                    ...
                    {/* Destination */}
                    <div className="text-[#978A7B] dark:text-white font-bold text-sm md:text-base mb-1">
                      {item.destination}
                    </div>
                    <div className="text-[#978A7B] dark:text-gray-400 text-xs md:text-sm leading-tight px-1">
                      {item.time}
                    </div>
                  </div>
                ))}
            ...
            <div className="order-1 lg:order-2">
              <div className="bg-white dark:bg-[#000] rounded-lg p-4 sm:p-5 md:p-6 shadow-lg">
                {/* Title */}
                {/* <h3 className="text-[#978A7B] dark:text-white font-bold text-sm sm:text-base md:text-lg lg:text-xl mb-4 sm:mb-5 md:mb-6 uppercase tracking-wide text-center lg:text-left leading-tight sm:leading-normal">
                ...
                <div className="relative mb-3 sm:mb-4">
                  <div
                    className="relative aspect-video rounded-lg overflow-hidden bg-[#00314a] dark:bg-[#57432A] cursor-pointer hover:opacity-90 transition-opacity duration-300"
                    onClick={handleMapImageClick}
                  >
                    <Image
                      src="/images/baccarat-residences-by-aldar/baccarat_map.png"
                      alt="Location Map"
                      fill

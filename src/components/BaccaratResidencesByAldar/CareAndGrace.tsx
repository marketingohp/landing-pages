...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "Rain room",
      icon: "/images/baccarat-residences-by-aldar/amenities/rain_room.png",
    },
    {
      name: "Luxury spa and treatment suites",
      icon: "/images/baccarat-residences-by-aldar/amenities/spa.png",
    },
    {
      name: "Wellness centre",
      icon: "/images/baccarat-residences-by-aldar/amenities/wellness_center.png",
    },
    {
      name: "Serene relaxation lounge",
      icon: "/images/baccarat-residences-by-aldar/amenities/spa.png",
    },
    {
      name: "Infinity pool",
      icon: "/images/baccarat-residences-by-aldar/amenities/infinity_pool.png",
    },
    {
      name: "Children’s play area and club",
      icon: "/images/baccarat-residences-by-aldar/amenities/children_playroom.png",
    },
    {
      name: "Private Dining",
      icon: "/images/baccarat-residences-by-aldar/amenities/dining_room.png",
    },
    {
      name: "Private screening room",
      icon: "/images/baccarat-residences-by-aldar/amenities/screening_room.png",
    },
    {
      name: "Exclusive pool lounge",
      icon: "/images/baccarat-residences-by-aldar/amenities/swimming_pool.png",
    },
  ];

  return (
    <section className="py-20 lg:py-32 bg-[#FFF9F3] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#57432A] dark:text-white mb-8"
            style={{ fontFamily: "var(--font-playfair), serif" }}
          >
            {t("royal.care.title")}
          </h2>
          <p className="text-base sm:text-lg text-[#57432A] dark:text-gray-300 max-w-5xl mx-auto mb-8 sm:mb-10 md:mb-12 px-2">
            {t("royal.care.desc")}
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              <div className="w-32 h-32 mx-auto mb-4 rounded-full dark:bg-[#3e301e] flex items-center justify-center shadow-lg text-4xl hover:scale-110 transition-transform duration-300">
                <img
                  src={amenity.icon}
                  width={200}
                  height={200}
              ...
              <p className="text-[#57432A] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#57432A] dark:bg-[#57432A] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#050708]/80 dark:hover:bg-[#050708]/90 transition-colors relative z-20"
          >
                  ...
                  <SwiperSlide key={index}>
                    <div className="relative w-full h-[600px] md:h-[700px] lg:h-[800px] overflow-hidden">
                      ...
                      <div className="absolute inset-0">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-br from-[#050708]/80 via-[#050708]/60 to-[#050708]/80 dark:from-[#0a0a0a]/90 dark:via-[#1a1a1a]/80 dark:to-[#2a4a6c]/90"></div>

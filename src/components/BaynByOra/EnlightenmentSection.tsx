    ...
    >
      <div className="container mx-auto py-10 px-4 lg:px-8">
        <div className="text-center mb-12">
          <h2
            className="text-2xl md:text-4xl lg:text-5xl text-[#00314a] dark:text-white mb-8"
        ...
        <div className="text-center">
          {/* <p className="text-base sm:text-lg text-[#00314a] dark:text-gray-300 max-w-4xl mx-auto mb-8 sm:mb-10 md:mb-12 px-2">

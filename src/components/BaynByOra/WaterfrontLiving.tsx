    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8">
        <div className="text-center mb-5">
          <h2
            className="text-2xl md:text-4xl lg:text-5xl text-[#00314a] dark:text-white mb-6"
            style={{ fontFamily: "var(--font-playfair), serif" }}
            dangerouslySetInnerHTML={{ __html: t("royal.waterfront.title") }}
          ></h2>

          {/* <div className="max-w-8xl mx-auto space-y-4 text-[#00314a] dark:text-gray-300 text-4xl py-2">
            <p
              className="custom-mobile-display-style1"
              dangerouslySetInnerHTML={{ __html: t("royal.waterfront.desc2") }}
            ></p>
          </div> */}
          <div className="max-w-5xl mx-auto space-y-4 text-[#00314a] dark:text-gray-300 text-lg py-4">
            <p
          ...
          >
            ...
            <div className="flex flex-col md:hidden space-y-4">
              ...
              <div className="px-4 py-3 text-center border-b border-[#00314a] dark:border-gray-400 border-opacity-30">
                <div className="text-[#00314a] dark:text-white font-normal text-sm leading-relaxed">
                  LOCATION: <br /> Ghantoot
                </div>
              </div>
              ...
              <div className="px-4 py-3 text-center border-b border-[#00314a] dark:border-gray-400 border-opacity-30">
                <div className="text-[#00314a] dark:text-white font-normal text-sm leading-relaxed">
                  3 & 4 BR Townhouses <br /> 4 BR Core Villas
                </div>
              </div>
              ...
              <div className="px-4 py-3 text-center">
                <div className="text-[#00314a] dark:text-white font-normal text-sm leading-relaxed">
                  5 BR Gemini & Double Height Villas
                  <br />
                  Signature Mansions
                </div>
              </div>
            ...
            <div className="hidden md:flex md:flex-wrap md:items-center md:justify-center gap-0 min-w-max">
              ...
              <div className="flex-1 min-w-[200px] px-6 md:px-8 py-4 text-center">
                {/* <div className="text-[#00314a] dark:text-white font-bold text-sm md:text-base mb-1 uppercase tracking-wide">
                  LOCATION:
                </div>
                <div className="text-[#00314a] dark:text-white font-normal text-sm md:text-base leading-relaxed">
                  Al Reem ISLAND
                </div> */}
                <div className="text-[#00314a] dark:text-white font-normal text-sm md:text-base leading-relaxed">
                  LOCATION: <br /> Ghantoot
              ...
              <div className="flex-1 min-w-[200px] px-6 md:px-8 py-4 text-center">
                ...
                <div className="text-[#00314a] dark:text-white font-normal text-sm md:text-base"></div> */}
                <div className="text-[#00314a] dark:text-white font-normal text-sm md:text-base leading-relaxed">
                  By <br /> ORA Developers
                </div>
              </div>
              ...
              <div className="flex-1 min-w-[200px] px-6 md:px-8 py-4 text-center">
                <div className="text-[#00314a] dark:text-white font-normal text-sm md:text-base leading-relaxed">
                  Signature Mansions
                  <br />5 BR Gemini & Double Height Villas
                </div>
              </div>
              {/* Vertical Separator */}
              <div className="w-px h-20 bg-[#00314a] dark:bg-gray-400 opacity-30"></div>
        ...
        {/* <div className="grid grid-cols-3 md:grid-cols-6 gap-8 mb-12">
          {travelTimes.map((item, index) => (
            <div key={index} className="text-center">
              ...
              <div className="text-[#00314a] dark:text-white font-bold text-lg mb-2">
                {item.time}
              </div>
              <div className="text-[#00314a] dark:text-gray-400 text-sm">
                {item.destination}
              </div>
            </div>
          ))}

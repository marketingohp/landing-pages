...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "Adult and Kids Pool",
      icon: "/images/bayn-ora/amenities/Adult_and_KIDS_POOL.png",
    },
    {
      name: "Central Park",
      icon: "/images/bayn-ora/amenities/Central_Park.png",
    },
    {
      name: "Cycling Tracks",
      icon: "/images/bayn-ora/amenities/Cycling_Tracks.png",
    },
    {
      name: "Dedicated Dog Park",
      icon: "/images/bayn-ora/amenities/Dedicated_Dog_Park.png",
    },
    {
      name: "Gazelle Park",
      icon: "/images/bayn-ora/amenities/gazelle_park.png",
    },
    {
      name: "Mediterranean Inspired Residential Areas",
      icon: "/images/bayn-ora/amenities/Mediterranean_Inspired_Residential_Areas.png",
    },
    {
      name: "Naseem Plaza",
      icon: "/images/bayn-ora/amenities/Naseem_Plaza.png",
    },
    {
      name: "Pathways Linking Amenities",
      icon: "/images/bayn-ora/amenities/Pathways_Linking_Amenities.png",
    },
    // {
    ...
    <section className="py-20 lg:py-32 bg-[#f5f5f0] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#00314a] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              ...
              <p className="text-[#00314a] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#00314a] dark:bg-[#2a4a6c] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#00314a]/90 dark:hover:bg-[#2a4a6c]/90 transition-colors relative z-20"
          >

...
export default function InteriorCarousel() {
  ...
  const images = [
    "/images/bayn-ora/Ora_Bayn_Brochure_1.jpg",
    "/images/bayn-ora/Ora_Bayn_Brochure_2.jpg",
    "/images/bayn-ora/Ora_Bayn_Brochure_3.jpg",
    "/images/bayn-ora/Ora_Bayn_Brochure_4.jpg",
    "/images/bayn-ora/Ora_Bayn_Brochure_5.jpg",
  ];

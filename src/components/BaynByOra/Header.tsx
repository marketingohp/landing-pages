          ...
          >
            <div
              className={`text-3xl lg:text-4xl transition-colors duration-300 ${
                isScrolled
                  ? "text-[#00314a] dark:text-gray-100"
                  : "text-[#00314a] dark:text-gray-100"
              }`}
              style={{ fontFamily: "var(--font-playfair), serif" }}
            >
              <img
                src="/images/bayn-ora/bayn_logo.webp"
                width={100}
                height={100}
                style={{ width: "120px" }}
                alt="one residences"
            ...
            <div
              className={`text-xs lg:text-sm font-sans uppercase tracking-wider transition-colors duration-300 ${
                isScrolled
                  ? "text-[#00314a]/80 dark:text-gray-300"
                  : "text-[#00314a]/80 dark:text-gray-300"
              }`}
            >
              {/* {t("royal.tagline")} */}
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${
                isScrolled
                  ? "text-[#00314a] dark:text-gray-100 hover:bg-[#00314a]/10 dark:hover:bg-gray-800/50"
                  : "text-[#00314a] dark:text-gray-100 hover:bg-white/10 dark:hover:bg-gray-800/50"
              }`}

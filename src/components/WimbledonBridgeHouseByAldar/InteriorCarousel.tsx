...
export default function InteriorCarousel() {
  ...
  const images = [
    "/images/wimbledon-bridge-house/interior/WBH_Brochure_31.jpg",
    "/images/wimbledon-bridge-house/interior/WBH_Brochure_35.jpg",
    "/images/wimbledon-bridge-house/interior/WBH_Brochure_36.jpg",
    "/images/wimbledon-bridge-house/interior/WBH_Brochure_42.jpg",
  ];

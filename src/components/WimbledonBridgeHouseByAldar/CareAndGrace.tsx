...
export default function CareAndGrace() {
  ...
  const amenities = [
    {
      name: "Concierge",
      icon: "/images/wimbledon-bridge-house/amenities/concierge_icon.png",
    },
    {
      name: "Gym",
      icon: "/images/wimbledon-bridge-house/amenities/club_icon.png",
    },
    {
      name: "Co-working space",
      icon: "/images/wimbledon-bridge-house/amenities/coworking_space_icon.png",
    },
    {
      name: "Parking",
      icon: "/images/wimbledon-bridge-house/amenities/parking_icon.png",
    },
    {
    ...
    {
      name: "Restaurant",
      icon: "/images/wimbledon-bridge-house/amenities/restaurant_icon.png",
    },
    {
      name: "Lounge areas",
      icon: "/images/wimbledon-bridge-house/amenities/lounge_icon.png",
    },
  ];
    ...
    <section className="py-20 lg:py-32 bg-[#FFF9F3] dark:bg-[#1a1a1a] relative">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-12 ">
          <h2
            className="text-2xl md:text-4xl lg:text-4xl text-[#050708] dark:text-white mb-8"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {amenities.map((amenity, index) => (
            ...
            >
              <div className="w-32 h-32 mx-auto mb-4 rounded-full flex items-center justify-center shadow-lg text-4xl hover:scale-110 transition-transform duration-300">
                <img
                  src={amenity.icon}
                  width={200}
                  height={200}
              ...
              <p className="text-[#050708] dark:text-gray-200 text-sm font-sans uppercase tracking-wider leading-tight font-bold">
                {amenity.name}
              </p>
            </div>
          ))}
        ...
        <div className="text-center relative z-20">
          <button
            ...
            className="bg-[#050708] dark:bg-[#AC7B58] text-white px-8 py-4 rounded uppercase tracking-wider font-sans font-semibold hover:bg-[#050708]/80 dark:hover:bg-[#AC7B58]/60 transition-colors relative z-20"
          >
      ...
      >
        <PropertySearchForm
          formName="wimbledon-bridge-house"

...
export const metadata: Metadata = {
  title:
    "Yas Park Place by Aldar | Apartments for Sale on Yas Island Abu Dhabi",
  description:
    "Discover Yas Park Place by Aldar on Yas Island, Abu Dhabi. Modern studio to 3BR apartments near Yas Park, Yas Mall and Ferrari World with premium amenities and payment plan.",
  keywords: [

...
export const metadata: Metadata = {
  ...
  description:
    "Sobha City is a premium freehold community in Abu Dhabi by Sobha Realty, offering luxury apartments, townhouses, and villas with vast green spaces, 20km of trails, and prime connectivity to Yas Island.",
  keywords: [

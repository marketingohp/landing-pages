...
export const metadata: Metadata = {
  ...
  description: "The Beach House Fahid by Aldar is a premium waterfront residential project on Fahid Island, Abu Dhabi, offering modern apartments with beach access, Italian finishes, and strong investment potential near Yas and Saadiyat Islands.",
  keywords: [

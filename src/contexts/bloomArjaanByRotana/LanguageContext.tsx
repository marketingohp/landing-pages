...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "The Bloom Arjaan by Rotana",
    "royal.waterfront.desc1":
      "Part of the prestigious Park View complex, Bloom Arjaan by Rotana is ideally situated on picturesque Saadiyat Island, directly opposite New York University Abu Dhabi. This prime location attracts university staff, international students, and visiting lecturers, making it a highly sought-after address.",
    "royal.waterfront.desc2": "Luxury Serviced Apartments on Saadiyat Island",
    ...
    "royal.discover.title": "Your Address, Your Prestige ",
    "royal.discover.desc":
      "Wake up to the  sparkling waters and golden beaches just minutes away. Live where culture, education, and leisure converge in perfect harmony.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "Live, Relax, and Entertain in Style",

...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Reem Hills",
    "royal.waterfront.title2":
      "blends heritage charm with outstanding connectivity",
    "royal.waterfront.desc1":
      "Reem Hills is a gated community where leisure, serenity, and healthy living come together within a diverse environment. The development is formed in flowing layouts overlooking man-made hills, beaches, and a canal, offering a setting defined by its surroundings.",
    ...
    "royal.enlightenment.title": "A Community Thriving In Nature's Ebrace",
    "royal.enlightenment.desc":
      "Every corner of Reem Hills is designed to create a sense of calm, from the home to the surrounding environment. The community offers a range of options that support a serene, healthy, and balanced lifestyle. It brings together spaces that encourage engagement, interaction, and everyday enjoyment.",
    ...
    "royal.discover.desc":
      "This is a location where luxury, tranquility, and carefully considered surroundings come together. It offers a setting that supports a balanced lifestyle, with access to key destinations while maintaining a sense of calm. A place designed to meet everyday needs while offering a higher standard of living.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "Ameneties At Your Doorstep",
    "royal.care.desc":
      "At Reem Hills, daily life is supported by a wide range of amenities designed to meet every need. The community is planned to promote a calm, well-balanced lifestyle, with integrated security systems that ensure a constant sense of safety and peace of mind.",

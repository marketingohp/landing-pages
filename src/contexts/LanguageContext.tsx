...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Situated in the heart of Yas Island",
    "royal.waterfront.desc1":
      "Directly on the waterfront of Yas Bay. STELLAR features a curated collection of 144 exclusive residences, designed with ELIE SAAB’s signature style, clean geometry, natural materials, generous light, and refined finishes.",
    ...
    "royal.hotel.explore": "EXPLORE AMENITIES",
    "royal.discover.title": "Discover the One Residences on Reem Island.",
    "royal.discover.desc":
    ...
    "royal.care.title": "EVERY DETAIL IS A GESTURE OF CARE AND QUIET GRACE.",
    "royal.care.viewAll": "VIEW ALL AMENITIES",
    "royal.dreams.title":

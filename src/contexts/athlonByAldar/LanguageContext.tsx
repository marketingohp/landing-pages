...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Athlon By Aldar Properties",
    "royal.waterfront.title2":
      "The first community in Dubai that makes movement a natural part of life",
    "royal.waterfront.desc1":
      "Find a progressive concept in urban living at Athlon by Aldar Properties, Dubai's head dynamic wellness community lined with premium homes. Grasping the ethos of dynamic living, the recently tended to advancement rethinks the cutting edge way of life, consistently joining development into day by day schedules. Planned in collaboration with prosperity specialists, this inventive community offers an unparalleled environment, where inhabitants can flourish and live effectively. Settled in a dynamic neighborhood and complemented by premium administrations, it guarantees a special way of life within the heart of Dubai. ",
    ...
    "royal.enlightenment.title": "Designed To Move You",
    "royal.enlightenment.desc":
      "Our design ethos is to create a unique environment that helps people move. Developed around active design principles with wellbeing experts, Athlon seamlessly merges walking & cycling loops with lush, green parks and spaces to connect. Wherever you go in this luxury community, you’re never more than 5 minutes from your next exhilarating activity.",
    ...
    "royal.discover.title": "Surrounded by Key Destinations and Essentials",
    "royal.discover.desc":
      "Perfectly positioned in Dubailand, the new development is only 25 minutes from Dubai International Airport and 30 minutes from Jumeirah Beach. Set within one of the largest green spaces in Dubai, the Athlon community is surrounded by nature.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "For Every Age & Interest ",
    "royal.care.desc":

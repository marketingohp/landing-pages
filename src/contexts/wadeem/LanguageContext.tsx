...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Designed by You. Defined by Nature",
    "royal.waterfront.title2": " WHERE ARCHITECTURAL ELEGANCE",
    "royal.waterfront.desc1":
      "Set within a vibrant yet tranquil island setting, Wadeem Hudayriat presents freehold residential plots crafted for those seeking a truly personalized luxury living experience. Generous spaces, light-filled surroundings, and a seamless balance between modernity and nature create the perfect canvas for architectural creativity and refined living.",
    ...
    "royal.enlightenment.title": "Live Where the City Meets the Sea",
    ...
    "royal.discover.title": "An Exclusive Address on Hudayriyat Island",
    "royal.discover.desc":
      "Perfectly positioned on Hudayriyat Island with seamless access to the city and coastline.",

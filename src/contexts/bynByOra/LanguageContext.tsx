...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Where Two Worlds Meet, Yours Begins",
    "royal.waterfront.title2": " WHERE ARCHITECTURAL ELEGANCE",
    "royal.waterfront.desc1":
      "Located at the heart of the Emirates, Bayn is the bridge between movement and stillness. We’ve removed the limits and kept the connection. Here, roads don’t divide; they bring people together in a community designed to grow, breathe, and move with you.",
    ...
    "royal.enlightenment.title": "Harmony in Every Horizon",
    "royal.enlightenment.desc":
      " Ideally positioned in Ghantoot, Bayn is ORA’s latest masterpiece, bridging the gap between the skyline of Dubai and the soul of Abu Dhabi. It is a destination where architectural brilliance meets the tranquility of lagoons and lush parks.",
    ...
    "royal.discover.title": "Bayn by ORA: Centered Between Two Worlds",
    "royal.discover.desc":
      "Bayn is strategically located in the serene coastal enclave of Ghantoot, serving as the ultimate bridge between Dubai and Abu Dhabi. This prime location offers residents the rare luxury of a tranquil retreat without sacrificing the convenience of city life.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "World of Coastal Luxury & Wellness",
    "royal.care.desc":
      "Bayn is designed as a fully integrated, self-sustaining sanctuary where over 55% of the land is dedicated to open green spaces and water. It offers an unparalleled resort-style lifestyle with amenities that cater to every aspect of modern living.",

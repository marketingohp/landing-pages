...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "The wilds Residences",
    "royal.waterfront.title2": "Nurtured by Nature, Defined by Home",
    ...
    "royal.enlightenment.title": "WHERE PEACE IS FOUND",
    "royal.enlightenment.desc":
      "Experience the best of both worlds. The Wilds Residences place you at the center of Dubai, surrounded by the soothing sounds of trickling streams and the beauty of peaceful fields.",
    ...
    "royal.discover.title": "A Landmark of Serenity",
    "royal.discover.desc":

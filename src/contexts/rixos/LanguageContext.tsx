...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Rixos",
    "royal.waterfront.title2": "Life, Refined in Every Facet",
    "royal.waterfront.desc1":
      "Discover a sanctuary where every facet of life is elevated. Nestled on the prestigious Al Reem Island in Abu Dhabi, these branded residences offer more than just a home they offer a lifestyle encircled by water. Enjoy expansive island views, private terraces, and world-class hotel amenities. At Rixos Al Reem, your daily life is redefined by five-star hospitality and an abundance of community spaces designed for modern living.",
    "royal.waterfront.desc2":
      "Every unit comes with integrated smart home systems and built-in high-end kitchen appliances.",
    "royal.waterfront.explore": "EXPLORE RESIDENCES",
    "royal.waterfront.brochure": " REGISTER YOUR INTEREST",
    "royal.enlightenment.title": "Rooftop Luxury Above the City",
    "royal.enlightenment.desc":
      "Experience a new level of waterfront living at Rixos Al Reem Residences, where the Rooftop infinity pool becomes your private escape. Designed for relaxation and social moments alike, this elevated sanctuary offers breathtaking skyline and sea views, curated greenery, and a resort-inspired atmosphere bringing the signature Rixos lifestyle to Al Reem Island, Abu Dhabi.",
    ...
    "royal.discover.title": "Location & Connectivity",
    "royal.discover.desc":
      "Rixos Al Reem Residences is located on Al Reem Island, Abu Dhabi, just 600 meters off the city’s coast, offering a unique lifestyle where waterfront calm meets urban convenience. Positioned only 10 minutes from Downtown Abu Dhabi, the development enjoys excellent connectivity to the capital’s most iconic destinations, cultural landmarks, and premium lifestyle hubs. With easy access to parks, schools, shopping malls, and business districts, residents benefit from an exceptional address that blends island serenity with the energy of the city.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "Facilities & Amenities At Rixos Al Reem Residences",
    "royal.care.desc":
      "Rixos Al Reem Residences is crafted for every mood and moment, offering a thoughtfully curated collection of lifestyle amenities designed for wellness, leisure, and family living. Residents can enjoy a state-of-the-art gym, treatment room and traditional hammam-inspired rituals, along with a padel court and landscaped walking track. Families benefit from the Rixy Kids Club, Teens Club, family pool, kids’ pool and splash area, while leisure spaces include a rooftop plunge pool, private screening room, residents’ lounge, and attentive concierge services creating a lifestyle where every desire is within reach, yet truly beyond compare.",

...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "HUDAYRIYAT ISLAND",
    "royal.waterfront.title2":
      "THE HUDAYRIYAT SANCTUARY WHERE ARCHITECTURAL ELEGANCE",
    "royal.waterfront.desc1":
      "Discover a realm where avant-garde architecture meets the serene horizon of the Arabian Gulf. On Hudayriyat Island, we don't just build homes; we craft private sanctuaries for those who settle for nothing less than extraordinary.",
    "royal.waterfront.desc2": "MEETS BEACHFRONT SERENITY",
    "royal.waterfront.explore": "EXPLORE RESIDENCES",
    "royal.waterfront.brochure": " REGISTER YOUR INTEREST",
    "royal.enlightenment.title": "Where the Sea Becomes Your Backyard",
    "royal.enlightenment.desc":
      "Wake up to the rhythmic pulse of the waves and the gentle sea breeze. Experience a boutique waterfront lifestyle that seamlessly blends pristine white beaches with world-class leisure,  making every moment feel like a permanent escape.",
    ...
    "royal.discover.title": "At the Center of Everything, Away from it All",
    "royal.discover.desc":
      "Experience the ultimate privacy of island living while staying just minutes away from the vibrant heart of Abu Dhabi. At Hudayriyat, you are perfectly positioned where the city’s pulse meets the ocean’s calm.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "A World Crafted to Enrich Your Life",
    "royal.care.desc":
      "Life at Hudayriyat extends far beyond the walls of your home. It is an ecosystem of extraordinary experiences designed to redefine daily luxury, from world-class sporting arenas to the serene stillness of the shore.",

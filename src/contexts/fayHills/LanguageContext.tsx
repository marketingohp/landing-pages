...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Taraf Fay Hill",
    "royal.waterfront.desc1":
      "<b>ONE Fay Hills</b>, is an exclusive luxury residential development by  <b> Taraf Holding, </b> crafted for discerning homeowners who seek architectural purity, elevated living, and enduring value. Set within the forward-thinking environment of <b> Masdar City, </b>, this boutique community offers a rare balance between modern sophistication and tranquil natural surroundings.",
    "royal.waterfront.desc2":
      "A PRIVATE HILLTOP ADDRESS. REFINED LUXURY, REIMAGINED.",
    "royal.waterfront.explore": "EXPLORE RESIDENCES",
    "royal.waterfront.brochure": " REGISTER YOUR INTEREST",
    "royal.enlightenment.title": "A Lifestyle Curated for Well-Being",
    "royal.enlightenment.desc":
      "The community is master-planned around serenity and exclusivity. Landscaped green corridors, resort-style pool areas, waterfront-inspired features, and thoughtfully designed social spaces foster a balanced lifestyle without compromising privacy.",
    ...
    "royal.discover.title":
      "Where every journey begins from a remarkable address",
    "royal.discover.desc":
      "Step into a world of unparalleled comfort and elegance. Enjoy inspiring city views and effortless access to premier destinations. Embrace a lifestyle that is sophisticated, serene, and always connected.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "Designed to elevate your everyday living experience.",

...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "TARA Park Apartments",
    "royal.waterfront.title2":
      "blends heritage charm with outstanding connectivity",
    "royal.waterfront.desc1":
      "The residence reflects a vision of smart, accessible urban living, where every space, path, and moment is designed to bring people together. Surrounded by greenery and just minutes from Reem Mall and Fay Park, Tara Park offers a genuine sense of home in one of Abu Dhabi’s most sought-after neighbourhood.",
    ...
    "royal.enlightenment.title": "Modern Living At the heart of Reem Island",
    ...
    "royal.discover.title": "Steps from Everything",
    "royal.discover.desc":
      "Located in the heart of Al Reem Island, opposite to Reem Mall Strategically posiitoned near Abu Dhabi's key landmarks, Tara Park offers fast access to ADGM, Galleria Mall, and Downtown Abu Dhabi, placing business, shopping, and entertainment whitin minutes.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "Designed For Living. Built For Belonging.",
    "royal.care.desc":
      "At Tara Park, a complete lifestyle shaped around comfort, activity, privacy, and connection awaits. The community features a modern swimming pool, a dedicated kids’ pool, and a fully equipped gym for everyday wellness.",

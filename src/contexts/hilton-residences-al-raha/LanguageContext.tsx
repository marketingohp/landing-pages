...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Hilton Residences Al Raha",
    "royal.waterfront.title2":
      "The global hospitality icon’s legacy in Hilton Residences Abu Dhabi Al Raha",
    "royal.waterfront.desc1":
      "By the sea that once guided pearl divers home, Hilton Residences Abu DhabiAl Raha blends the UAE’s rich heritage and a global legacy of hospitality with elegance, purpose and precision. Rooted in Abu Dhabi’s timeless relationship with the sea, it is thoughtfully curated for you with openness, graceful balance, and the spirit of togetherness, values that reflect the emirate’s cultural soul. It’s a retreat you call your own, shaped by authenticity, refined by expertise and alive with possibility.",
    ...
    "royal.enlightenment.title":
      "Nature-inspired designs for harmonious living",
    "royal.enlightenment.desc":
      "The interiors draw from the sensory richness of Abu Dhabi’s natural landscapes, from the muted greens of coastal waters to soft desert neutrals, grounded by earthen browns and energised by a bold crimson accent. The natural tones and tactile materials together create a harmonious blend of calm and contrast, evoking a lifestyle that is both rooted and refined. From the open-plan living and kitchen area to the intimate bedroom and bathroom retreat, each space is carefully curated to balance comfort, elegance and the tranquillity of shoreline living.",
    ...
    "royal.discover.title": "Abu Dhabi’s finest within easy reach",
    "royal.discover.desc":
      "Nestled along the pristine Al Raha shoreline, Hilton Residences Abu Dhabi Al Raha is seamlessly connected to Abu Dhabi’s exceptional retail, leisure and lifestyle possibilities. It blends effortless reach with exclusive access to spectacular waterfronts, tranquil green spaces and luxurious possibilities. This central location is within minutes from the airport, world-class leisure amenities, retail hotspots, cultural hubs and more.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "Resort-style amenities for your everyday",
    "royal.care.desc":
      "The exquisite amenities here unfold like the tide to nurture your overall wellness. They flow seamlessly from acty to serenity, indoors to outdoors and from nourishing your body to pampering your senses. Here are some of the world-class amenities for a lifestyle that moves to your pace and rhythm:",

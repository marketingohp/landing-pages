...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Radisson Residences",
    "royal.waterfront.desc1":
      "Radisson Residences offers a sophisticated lifestyle across three contemporary towers, perched atop a beautifully landscaped podium featuring curated cafés, premium services, and shaded walkways amidst lush greenery. A branded residence by a world renowned hospitality name, set on Reem Island’s waterfront, where the city skyline blends seamlessly with tranquil mangroves.",
    "royal.waterfront.desc2": "An Exceptional Address for Modern Living",
    "royal.waterfront.explore": "EXPLORE RESIDENCES",
    "royal.waterfront.brochure": " REGISTER YOUR INTEREST",
    "royal.enlightenment.title": " A New Standard of Waterfront Living",
    ...
    "royal.discover.title": "Prime Waterfront Location",
    "royal.discover.desc":
      "Nestled on the prestigious Reem Island, Radisson Residences offers seamless connectivity to Al Maryah Island, Downtown Abu Dhabi, and Zayed International Airport, while providing a serene escape amid mangroves and waterfront views.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.desc":
      "Discover world-class amenities designed for comfort and wellness",
    "royal.care.title": "Luxury Amenities for a Modern Lifestyle",

...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Bashayer Residences",
    "royal.waterfront.title2": " WHERE ARCHITECTURAL ELEGANCE",
    "royal.waterfront.desc1":
      "Bashayer Residences is more than an address; it is a legacy of waterfront living by Modon Properties. Inspired by the timeless allure of European coastal villages, this collection of 1 to 4-bedroom apartments and penthouses harmonizes Abu Dhabi’s rich cultural heritage with the bold ambitions of a modern island lifestyle. Here, prosperity and future thrive amidst lush landscapes and the shimmering Gulf waters.",
    "royal.waterfront.desc2": "Where European Charm Meets Arabian Horizon",
    "royal.waterfront.explore": "EXPLORE RESIDENCES",
    "royal.waterfront.brochure": " REGISTER YOUR INTEREST",
    "royal.enlightenment.title": "A World of Discovery at Your Doorstep",
    "royal.enlightenment.desc":
      "Step out onto a vibrant promenade where the sea breeze meets a bustling community spirit.",
    ...
    "royal.discover.title":
      "Where the Island’s Serenity Meets the City’s Pulse",
    "royal.discover.desc":
      "Bashayer Residences is ideally positioned at the heart of Hudayriyat Island’s most vibrant shoreside region. Elevated above the waterfront promenade, this address offers the perfect balance between a secluded luxury escape and a well-connected urban lifestyle. ",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "Where World-Class Leisure Meets the Shore",
    "royal.care.desc":
      "At Bashayer Residences, your home extends to a vibrant waterfront promenade and a lush island landscape. Every facility is curated to offer a balance of high-energy activity and serene relaxation.",

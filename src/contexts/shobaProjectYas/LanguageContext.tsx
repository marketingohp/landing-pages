...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Yas Riva Residences",
    "royal.waterfront.title2": " WHERE ARCHITECTURAL ELEGANCE",
    "royal.waterfront.desc1":
      "Discover the pinnacle of luxury at Yas Riva, an exclusive residential sanctuary by Aldar Properties. Featuring a premium collection of 4, 5, and 6-bedroom villas, Yas Riva seamlessly blends contemporary aesthetics with timeless craftsmanship. Whether you choose an inland retreat or a canal-front villa, you are invited to a lifestyle defined by panoramic Gulf views and serene waterfront access.",
    ...
    "royal.discover.title": "The Heart of Abu Dhabi’s Entertainment Hub",
    "royal.discover.desc":
      "Strategically located on the northern shores of Yas Island, Yas Riva offers the perfect balance between secluded waterfront serenity and urban excitement.",

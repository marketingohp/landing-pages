...
const translations = {
  en: {
    ...
    "royal.enlightenment.title": "Everyone Here Stays Connected",
    "royal.enlightenment.desc": "A place where you and your children can move freely. Where mornings start with calm and sunlight, not traffic. Where evenings are meant for spending time outdoors, together.",
    ...
    "royal.care.title": "Designed as One Community",
    "royal.care.desc": "Homes near top schools and universities. Wellness at your doorstep. Daily essentials seamlessly woven into the neighborhood. Here, everything flows together as one.",

...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "The Wilds",
    "royal.waterfront.title2": "A home grown in harmony",
    "royal.waterfront.desc1":
      "Wake up to birdsong each morning, and step outside to experiences growing all around you. A dip in the natural pool, a wander along the scenic trails, or a wildlife watching experience with your children in The Nest Signature Pavilion. The only limit is your imagination, and here, that roams free.",
    ...
    "royal.enlightenment.title": "Life as Nature intended",
    "royal.enlightenment.desc":
      "Introducing The Wilds in Dubai. Homes interwoven with natural greenery and outdoor spaces that nourish young minds. Own your home and spend your day adventuring with the little ones, finding balance in the great outdoors and making new connections at The Nest Signature Pavilion",
    ...
    "royal.discover.title": "Prime Location",
    "royal.discover.desc":
      "Nestled in the heart of Dubai, The Wilds is close to the energy of the city, yet immersed in a world where nature takes the lead.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title":
      "Discover a rare collection of 38 exclusive mansions at the heart of The Wilds",
    "royal.care.desc":
      "Nature-led amenities and a commitment to sustainability underpin the development's future driven design, with features such as The Nest Signature Pavillion, nature-inspired pools and streams.",

...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "seamont autograph collection residences",
    "royal.waterfront.title2": "Iconic Waterfront Residences",
    "royal.waterfront.desc1":
      "Escape to a retreat that breathes with the sea. Seamont offers a standard of living defined by quiet elegance, placing you at the pulse of the capital while guarding your peace.",
    "royal.waterfront.desc2": "Iconic Waterfront Residences",
    "royal.waterfront.explore": "EXPLORE RESIDENCES",
    "royal.waterfront.brochure": " REGISTER YOUR INTEREST",
    "royal.enlightenment.title":
      "An Architectural Masterpiece, Rising from the Water",
    "royal.enlightenment.desc":
      "Seamont Residences bring a new standard of prominence to the waterfront. As part of the globally acclaimed Autograph Collection, this project offers a rare blend of private sanctuary and urban connectivity. Featuring panoramic sea views and high-end finishes, these branded homes are meticulously crafted for the modern connoisseur.",
    ...
    "royal.discover.title": "The Ultimate Hub of Connectivity",
    "royal.discover.desc":
      "Strategically located at the gateway of Abu Dhabi’s growth corridor, Seamont Autograph Collection offers unparalleled access to the city’s most critical landmarks.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "The Mark of a Unique Lifestyle",
    "royal.care.desc":
      "At Seamont, amenities are not just features; they are a curated collection of moments designed to reflect the Autograph Collection’s soul.",

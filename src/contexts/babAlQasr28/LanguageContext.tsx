...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Bab Al Qasr Royal 28 ",
    "royal.waterfront.title2": "A Legacy of Royal Elegance on Al Reem Island",
    "royal.waterfront.desc1":
      "Step into a world where grandeur meets the modern skyline. Bab Al Qasr Royal 28 offers more than a home; it provides a lifestyle of timeless sophistication. Inspired by royal aesthetics and crafted with meticulous detail, these residences are designed for those who demand an address that reflects their success.",
    ...
    "royal.enlightenment.title": " The New Benchmark of Luxury on Al Reem",
    ...
    "royal.discover.title":
      "At the Heart of Prestige, Opposite Sorbonne University",
    "royal.discover.desc":
      "Proudly positioned opposite Sorbonne University Abu Dhabi, Royal Residence 28 offers an exceptional living experience in a prime location, blending cultural proximity with panoramic island views.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "Amenities Designed for Royalty",
    "royal.care.desc":
      "Beyond the majestic columns and the grand high-ceiling lobby, Royal 28 offers a suite of world-class amenities that mirror the luxury of French palaces.",

...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Radiant Waves",
    "royal.waterfront.title2":
      "Urban Living with a Waterfront Feel on Al Reem Island",
    "royal.waterfront.desc1":
      "Radiant Waves rises across 45 levels with 644 meticulously designed residences in Shams Abu Dhabi, from canal-front villas to sky duplexes, offering open layouts and panoramic canal, skyline, and partial sea views.",
    ...
    "royal.discover.title": "Connected to Everything",
    "royal.discover.desc":
      "Minutes from Downtown Abu Dhabi, yet surrounded by community life, residents enjoy unmatched access to schools, universities, malls, healthcare, and open green spaces. Radiant Waves turns daily convenience into a defining luxury",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "Active Living, Elevated",
    "royal.care.desc":
      "The amenities deck is the central social and wellness hub of Radiant Waves. Designed for activity, balance, and outdoor enjoyment, it merges recreation with open views. Swimming pools with relaxing views",

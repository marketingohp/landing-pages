...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Manchester City - Yas Island",
    "royal.waterfront.title2": "Elite Waterfront Living at Yas Canal",
    "royal.waterfront.desc1":
      "Experience a first-of-its-kind, sports-branded residential community where luxury meets high-performance living. Located in Al Bahyah along the iconic Yas Canal, this development is designed for those seeking an iconic, elite lifestyle rooted in wellness and global prestige.",
    ...
    "royal.discover.title": "Prime Location & Connectivity",
    "royal.discover.desc":
      "Enjoy a direct waterfront setting with panoramic views of the canal and Abu Dhabi’s premier entertainment hubs.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "World-Class Amenities: A Sport-Waterfront Lifestyle",
    "royal.care.desc":
      "This community stands out for its unique sport-waterfront ecosystem, featuring professional-grade facilities dedicated to fitness and recovery.",

...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Wimbledon Bridge House",
    "royal.waterfront.title2":
      "blends heritage charm with outstanding connectivity",
    "royal.waterfront.desc1":
      "A place where village charm meets London connectivity, Wimbledon Bridge House is perfectly positioned to place everything at your fingertips, from leafy commons and boutique shopping streets to swift links across the capital. Wimbledon seamlessly blends heritage charm with outstanding connectivity to central London and beyond.",
    ...
    "royal.enlightenment.title": "Environments That Invite Activity",
    "royal.enlightenment.desc":
      "Designed by Johnson Naylor, a renowned interior architecture and design practice based in Clerkenwell, London, this building reflects the studio’s signature attention to detail, thoughtful materials, and timeless design. Sitting at the heart of the apartment, the living space responds to light, proportion and movement, while layered textures and authentic materials create environments that invite activity, reflection and connection.",
    ...
    "royal.discover.title": "Where Heritage Meets Vibrant Living",
    "royal.discover.desc":
      "Located in the heart of Wimbledon, moments from the station, set between Richmond, Tooting and Wandsworth, Wimbledon is a neighbourhood of contrasts – quiet historic streets lead to bustling cafes and boutiques, while lawns and woodland enable effortless connection to nature.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title":
      "Complemented by Distinctive Social and Wellness Amenities",
    "royal.care.desc":
      "Commanding effortless reach across the capital, Wimbledon Bridge House provides a direct line to London’s opportunities designed with wellness in mind. Renowned for its world-class schools, expansive green spaces and village-like atmosphere.",

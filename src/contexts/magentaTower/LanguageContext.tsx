...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Magenta Tower By Aldar Properties",
    "royal.waterfront.title2": " Dubai First Active Living Community",
    "royal.waterfront.desc1":
      "Rise by Athlon Magenta Tower is a residence, transcending the concept of active and holistic living in Dubailand with 1 to 3-bedroom apartments by Aldar. Standing at the forefront, this building lies within Dubai’s prior active living master fully laid out, grand project. Set amongst the largest green regions, natives of this rising property will have a centric destination with quick access to the nearby and distant landmarks. Crafted to keep you engaged in a rhythm, this exquisite cluster finely merges walking & cycling loops with parks, abundant greenery, and spaces for shared communal indulgences. The insides of all private sanctuaries are impressively comfortable and dynamic, allowing you to witness breathtaking views with instant access to the amenity zone.",
    "royal.waterfront.desc2":
      "A Masterpiece of Waterfront Living on Yas Island",
    "royal.waterfront.explore": "EXPLORE RESIDENCES",
    "royal.waterfront.brochure": " REGISTER YOUR INTEREST",
    "royal.enlightenment.title": "Makes Movement a natural part of life",
    "royal.enlightenment.desc":
      "Sharing the same podium base with two other exceptional towers, it is a 21-level epitome of craftsmanship immersed in the greenery. The biophilic, sustainable, and sophisticated approaches are carefully aligned in this property, making life eco-friendly and full of relaxation and joyful experiences.",
    "royal.enlightenment.desc2":
      "Wadeem is a tranquil residential destination on Hudayriat Island, designed for those who value space, serenity, and balance. Surrounded by natural landscapes and enhanced by contemporary architecture, the project redefines modern island living in Abu Dhabi.",
    ...
    "royal.discover.title": "You can discover holistic living in its entirety",
    "royal.discover.desc":
      "  In the prime Dubailand locality, a residential development enjoys a peaceful location that is far as well as finely connected to the popular buzz of the Emirates. Positioned next to the Arabian Ranches 3, this property enjoys direct access to the Sheikh Zayed Bin Hamdan Al Nahyan Street, while other directions are also enveloped by Latifa Bint Hamdan and Emirates Roads. This carefully planned network of roads ensures an advantage of easier connectivity to the Cityland Mall, IMG World of Adventure, Plation Equestrian & Polo Club, and Dubai Autodrome.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title":
      "Plenty of attractions and facilities for an enhanced lifestyle",
    "royal.care.desc":
      "The unique theme of this building is a Rhythm Room, an in-house sound studio setup for music enthusiasts to rehearse, write, and unleash creativity. Furthermore, as you step outside this tower, you will discover a five-minute walking locality with high & mid-rise residences and a collection of unparalleled amenities and common spaces. Emark on an adventurous journey and create memories at the nature trail, skate park, monkey bars, balance training, and strength & conditioning podium. Many relaxations, socialisation, and recreational options of swimming pools, a yoga pavilion, a meditation deck, a reflexology path, a pet park, and a BBQ zone are also steps away from home.",

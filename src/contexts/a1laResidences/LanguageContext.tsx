...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "A1LA Residences",
    "royal.waterfront.title2": "A Symphony of Moonlit Living",
    "royal.waterfront.desc1":
      "Inspired by the soft, celestial glow of its namesake, A1LA Residence is a boutique sanctuary where modern luxury meets the quiet poetry of nature. Located on the prestigious Al Reem Island, this residence is defined by light, serenity, and a refined femininity that feels both soft and powerful , A1LA offers an intimate living experience for those who seek beauty that feels effortless and luxury that feels deeply human.",
    ...
    "royal.enlightenment.title": "Where Light Comes Home",
    "royal.enlightenment.desc":
      "Every detail is designed to feel effortless: architecture that breathes with openness, interiors that soothe with soft neutrals and natural textures, and curated spaces that invite both privacy and connection. A1LA is more than a place to live , it is a place to feel balanced, grounded, and beautifully at ease.",
    ...
    "royal.discover.title": "THE ESSENCE OF AL REEM",
    "royal.discover.desc":

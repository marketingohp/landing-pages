...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Jumeirah Residences <br /> Al Maryah Island",
    "royal.waterfront.title2": "Designed for Living, Connected to the City",
    "royal.waterfront.desc1":
      "Jumeirah Residences Al Maryah Island enjoys exceptional connectivity in Abu Dhabi’ s urban core, with direct access to The Galleria Mall, waterfront promenade, and dining districts. It’ s minutes from key hubs like Abu Dhabi Global Market and Cleveland Clinic, and a short drive to Downtown Abu Dhabi, Y as Island, and Zayed International Airport, seamlessly linking residents to work, leisure and lifestyle destinations.",
    ...
    "royal.enlightenment.title": "Smart Choice, Serene Lifestyle",
    "royal.enlightenment.desc":
      "Jumeirah Residences Al Maryah Island offers an elevated waterfront lifestyle with premium concierge services, personalised wellness experiences, private dining and access to leisure spaces inspired by Jumeirah’ s hospitality ethos. Residents enjoy curated social lounges, fitness and wellness facilities, indoor and outdoor pools, cinema and event spaces, plus immediate access to dining, retail and the scenic waterfront promenade for refined urban living.",
    ...
    "royal.care.title": "World-Class Amenities at Jumeirah Residences",
    "royal.care.desc":
      "Jumeirah Residences Al Maryah Island offers a curated suite of premium amenities designed for wellness, leisure and social living. Residents enjoy a state‑of‑the‑art fitness centre, indoor and outdoor pools, spa and treatment areas, private lounges, library and cinema, children ’ s play zones, event spaces, landscaped decks and waterfront dining and retail experiences, blending branded hospitality with everyday comfort and vibrant waterfront living.",

...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "The Wilds at Dubailand ",
    "royal.waterfront.title2":
      "The Wilds is designed with nature at its heart.",
    "royal.waterfront.desc1":
      "Introducing The Wilds in Dubai. Homes interwoven with natural greenery and outdoor spaces that nourish young minds. Own a 3 bedrooms villa or 5 to 6 bedrooms mansions and spend your days adventuring with the little ones, finding balance in the great outdoors and making new connections at The Nest Signature Pavilion. Wake up to birdsong each morning, and step outside to experiences growing all around you. A dip in the natural pool, a wander along the scenic trails, or a wildlife-watching experience with your children in The Nest Signature Pavilion. The only limit is your imagination, and here, that roams free.",
    ...
    "royal.enlightenment.title":
      "A benefit to both residents and the future of the UAE. ",
    "royal.enlightenment.desc":
      "At The Wilds, life is enriched by amenities that blend seamlessly with nature. Every space is designed to inspire connection, with the environment and each other. A suite of thoughtful services to elevate your lifestyle. From on-demand butler care and eco-friendly workshops to pet care and wellness programmes, every need is anticipated.",
    ...
    "royal.discover.desc":
      "Within the active Dubailand precinct, The Wilds by Aldar finds its home in a site which brings together peaceful serenity with excellent ease of access.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "Amenities Designed for Royalty",
    "royal.care.desc":
      "Within The Wilds by Aldar, residents find exceptional facilities that advance their everyday living standards. The community center comprises multiple wellness amenities such as modern fitness centers along with yoga areas and meditation rooms coupled with jogging paths and cycling paths that wind through greenery areas.",

...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Flow25",
    "royal.waterfront.title2": "Live the Symphony of Life",
    "royal.waterfront.desc1":
      "Flow25 redefines contemporary living through fluid architecture, generous outdoor spaces, and a seamless connection with nature. Thoughtfully designed for the UAE climate, it offers a calm, smart, and elevated lifestyle on Al Reem Island.",
    ...
    "royal.discover.title": "Flow Effortlessly! <br /> through the City",
    "royal.discover.desc":
      "Prime location in Abu Dhabi, on Al Reem Island, with easy access to Saadiyat Island, Central Abu Dhabi, and Zayed International Airport.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "Sky View Lounge",
    "royal.care.desc":
      "Elevated for stunning sea and city views, letting residents unwind, entertain, and soak in Al Reem Island’s vibrant atmosphere.",

...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Bab Al Qasr Seaview Residence 51",
    "royal.waterfront.title2":
      "blends heritage charm with outstanding connectivity",
    "royal.waterfront.desc1":
      "Bab  Al  Qasr  Seaview  Residence  51  introduces  a  refined  waterfront  lifestyle  at  Al  Raha  Beach. Positioned  within  one  of  Abu  Dhabi’s  most  sought- after waterfront destinations, this exclusive residential address combines architectural  elegance,  privacy,  and branded living in one distinguished setting.",
    ...
    "royal.enlightenment.title": "A Home Designed Around the Horizon",
    "royal.enlightenment.desc":
      "A 5 Stars waterfront address that redefines everyday living! This development introduces a different way of living in Abu Dhabi where open views, private spaces, and thoughtful design come together. Set along Al Raha Beach, offering a calm yet connected lifestyle shaped around comfort, space, and long term value.",
    ...
    "royal.discover.title": "Where the City Meets the Coast",
    "royal.discover.desc":
      "Located in Al Raha Beach, this address offers a balance between waterfront calm and city accessibility. Residents enjoy direct access to the promenade while staying connected to Abu Dhabi’s key destinations, business hubs, and lifestyle attractions.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "Designed Around How You Live",
    "royal.care.desc":
      "Every part of the community is created to support daily life  from quiet moments to active routines. The spaces are built to bring together wellness, relaxation, and social connection in one place.",

...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "An Iconic Address in the Heart ",
    "royal.waterfront.title2": "of Saadiyat’s Cultural District",
    "royal.waterfront.desc1":
      "More than a residence, The Row Saadiyat is a rhythmic harmony of light, space, and prestige. Set against the backdrop of the world's most ambitious cultural landscape, it is an invitation to live within a masterpiece.",
    ...
    "royal.enlightenment.title": " Where Culture Meets the Coast",
    "royal.enlightenment.desc":
      "The Row offers a unique 'Connect to Disconnect' lifestyle, placing you steps away from world-class art while ensuring a retreat of absolute privacy.",
    ...
    "royal.discover.title": "At the Heart of the Cultural Epicenter",
    "royal.discover.desc":
      "Ideally positioned in the heart of the Saadiyat Cultural District, The Row offers a front row seat to global landmarks and the pristine beauty of the Arabian Gulf.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "A Lifestyle Shaped by Wellbeing",
    "royal.care.desc":
      "Green open spaces, family-friendly amenities, and vibrant community facilities.",

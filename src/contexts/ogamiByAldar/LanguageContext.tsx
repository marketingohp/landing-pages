...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Ogami Water Chalets",
    "royal.waterfront.title2":
      "blends heritage charm with outstanding connectivity",
    "royal.waterfront.desc1": "Ogami Water Chalets introduces a low-rise coastal collection in Ras El Hekma designed around privacy, natural surroundings, and open living spaces. The project combines Mediterranean views with Japanese-inspired simplicity through landscaped pathways, swimmable lagoons, garden homes, and wide terraces.",
    "royal.waterfront.desc2": "Residents experience a quieter North Coast lifestyle connected to wellness spaces, beachfront experiences, retail destinations, and social hubs, all within a masterplanned community shaped around calm living.",
    "royal.waterfront.explore": "EXPLORE RESIDENCES",
    "royal.waterfront.brochure": "REGISTER YOUR INTEREST",
    "royal.enlightenment.title": "A Different Rhythm On The North Coast",
    "royal.enlightenment.desc": "Ogami introduces a layered coastal experience inspired by Mediterranean scenery and Japanese simplicity. Landscaped islands, swimmable lagoons, wellness spaces, and beachfront experiences come together to create a destination designed around calm living.",
    "royal.enlightenment.desc2": "The development balances privacy and connection through open spaces, social hubs, curated retail experiences, and homes designed to stay closely connected to nature, water, and light.",
    ...
    "royal.discover.title": "Connected To Egypt’s North Coast Destinations",
    "royal.discover.desc": "Positioned in Ras El Hekma along Egypt’s Mediterranean coastline, Ogami offers direct access to major North Coast destinations while maintaining a quieter atmosphere surrounded by beaches, lagoons, and landscaped open spaces.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "Experiences Shaped Around Coastal Living",
    "royal.care.desc": "Ogami combines beachfront experiences, wellness facilities, sports zones, social spaces, and retail destinations within a masterplanned coastal setting designed around comfort, movement, and uninterrupted sea views.",

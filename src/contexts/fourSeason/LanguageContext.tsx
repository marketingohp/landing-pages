...
const translations = {
  en: {
    ...
    "royal.discover.title": "Connected to Abu Dhabi’s Cultural Core",
    "royal.discover.desc":
      "Located on Saadiyat Beach, the residences enjoy proximity to Abu Dhabi’s key cultural, lifestyle, and business destinations while remaining surrounded by nature and open coastline.",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "Everyday Living, Elevated",
    "royal.care.desc":
      "Residents enjoy a curated collection of amenities designed to support wellness, relaxation, family life, and social connection — all within a private beachfront setting.",

...
const translations = {
  en: {
    ...
    "royal.waterfront.title": "Rotana Residence – Al Reem Island",
    "royal.waterfront.title2":
      "Branded towers in one of Abu Dhabi’s <br />  most  established  and high-demand residential destinations – Al Reem Island ",
    "royal.waterfront.desc1":
      "Rotana Residence offering two towers rise - not as opposites, but as complements. The Two Towers of Rotana Residences are a celebration of duality, of life lived in balance and time treasured, of energy and ease, curiosity and calm.",
    ...
    "royal.enlightenment.title": "Everyday Life is Connected to Nature",
    "royal.enlightenment.desc":
      "The podium at Flow25 is a living landscape where families gather and moments unfold naturally. Shaded walkways, native greenery, and biophilic design create a cool, calming outdoor environment to relax and connect all year round.",
    ...
    "royal.discover.title": "At The Centre of Everything",
    "royal.discover.desc":
      "Located on Al Reem Island, Rotana Residences enjoys exceptional connectivity to Abu Dhabi’s key destinations while remaining immersed in a vibrant residential community.  North Tower is next to fay park and South Tower is next to Sorbonne University ",
    "royal.discover.masterplan": "VIEW MASTERPLAN",
    "royal.care.title": "A World of Possibilities",
    "royal.care.desc":
      "5-Star Rotana Lifestyle Services, Residents will enjoy world-class branded living supported by Rotana’s renowned service excellence Every amenity is designed to enhance comfort, balance, and quality of life, creating a community where modern living feels effortless. ",
